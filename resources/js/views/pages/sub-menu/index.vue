        ...
        <div class="card">
          <div class="card-body">
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title">{{ $t("general.subMenuTable") }}</h4>
              ...
              >
                <div>
                  ...
                  >
                    ...
                    <b-form-checkbox v-model="setting.is_add_on" class="mb-1">
                      {{ $t("general.addOn") }}
                    </b-form-checkbox>
                  ...
                  >
                    <div class="d-inline-block" style="font-size: 15px">
                      {{ menuTreesPagination.from }}-{{
                        menuTreesPagination.to
                      }}
                      /
                    ...
                    <div class="d-inline-block">
                      <a
                        ...
                        @click.prevent="
                          getData(menuTreesPagination.current_page - 1)
                        "
                      >
                        <span>&lt;</span>
                      </a>
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            menuTreesPagination.last_page ==
                            menuTreesPagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="
                  ...
                  <div class="col-md-12 position-relative">
                    <div class="form-group">
                      ...
                      <multiselect
                        ...
                        :class="{
                          'is-invalid':
                            $v.create.menu_id.$error || errors.menu_id,
                        }"
                      >
                      </multiselect>
                      <div
                        v-if="!$v.create.menu_id.required"
                      ...
                      <template v-if="errors.menu_id">
                        <ErrorMessage
                          v-for="(errorMessage, index) in errors.menu_id"
                          :key="index"
              ...
              >
                <thead>
                  <tr>
                      ...
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            ...
                            @click="menuTrees.sort(sortString('name'))"
                          ></i>
                          <i
                    ...
                    <th v-if="setting.name_e">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="menuTrees.sort(sortString('name_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="menuTrees.sort(sortString('-name_e'))"
                    ...
                    <th v-if="setting.is_add_on">
                      <div class="d-flex justify-content-center">
                        <span>{{ $t("general.addOn") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="menuTrees.sort(sortString('name_e'))"
                ...
                <tbody v-if="menuTrees.length > 0">
                  ...
                  >
                    ...
                    <td v-if="setting.is_add_on">
                      <span
                        :class="[
                          data.is_add_on ? 'text-success' : 'text-danger',
                          'badge',
                        ]"
                      >
                        {{
                    ...
                    <td v-if="setting.menu_id">
                      <template v-if="data.menu">
                        {{
                          $i18n.locale == "ar"
                            ? `${data.menu.project_program_module.name} | ${data.menu.menu_folder.name}`
                            : `${data.menu.project_program_module.name_e} | ${data.menu.menu_folder.name_e}`
                        }}
                      </template>
                    </td>
                    <td v-if="enabled3" class="do-not-print">
                            ...
                            <div class="col-md-12 position-relative">
                              <div class="form-group">
                                ...
                                <multiselect
                                  ...
                                  :class="{
                                    'is-invalid':
                                      $v.edit.menu_id.$error || errors.menu_id,
                                  }"
                                >
                                </multiselect>
                                <div
                                  v-if="!$v.edit.menu_id.required"
                                  class="invalid-feedback"
                                >
                                  {{ $t("general.fieldIsRequired") }}
                                </div>
                            ...
                            <div class="col-12">
                              <div class="form-group">
                                ...
                                <b-form-group
                                  :class="{
                                    'is-invalid':
                                      $v.edit.is_add_on.$error ||
                                      errors.is_add_on,
                                    'is-valid':
                                      !$v.edit.is_add_on.$invalid &&
                                      !errors.is_add_on,
                                  }"
                                >
                                  <b-form-radio
