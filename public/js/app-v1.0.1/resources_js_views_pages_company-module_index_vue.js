        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/menu").then(function (res) {
                  _this3.menus = res.data.data;
                })["catch"](function (err) {
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.companyModulesPagination.last_page && this.current_page != this.companyModulesPagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/company-modules?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
          _this6.companyModules = l.data;
          _this6.current_page = l.pagination.current_page;
          _this6.companyModulesPagination = l.pagination;
          _this6.current_page = l.pagination.current_page;
        })["catch"](function (err) {
          sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
            icon: "error",
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 8:
                _this9.create = {
                  ...
                  menu_id: null,
                  allowed_users_no: "",
                  start_date: (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_8__.formatDateTime)(_this9.create.custom_date_start),
                  end_date: null,
                  custom_date_start: new Date(),
                  custom_date_end: null,
                  document_types: []
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _this10.getCompany();
              case 2:
                _context3.next = 4;
                return _this10.getModule();
              case 4:
                _context3.next = 6;
                return _this10.docType();
              case 6:
                _this10.create = {
                  company_id: "",
                  module_id: "",
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                companyModule = _this13.companyModules.find(function (e) {
                  return id == e.id;
                });
                _context4.next = 3;
                return _this13.getCompany();
              case 3:
                _context4.next = 5;
                return _this13.getModule();
              case 5:
                _context4.next = 7;
                return _this13.docType();
              case 7:
                _context4.next = 9;
                return _this13.getMenus();
              case 9:
                _this13.edit.company_id = companyModule.company.id;
                _this13.edit.module_id = companyModule.module.id;
                _this13.edit.menu_id = companyModule.menu_id;
                _this13.edit.allowed_users_no = companyModule.allowed_users_no;
                _this13.edit.custom_date_start = new Date(companyModule.start_date);
                _this13.edit.custom_date_end = companyModule.end_date ? new Date(companyModule.end_date) : null;
                _this13.edit.start_date = (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_8__.formatDateTime)(companyModule.start_date);
                _this13.edit.end_date = companyModule.end_date ? (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_8__.formatDateTime)(companyModule.end_date) : null;
                types = [];
                companyModule.document_types.forEach(function (e) {
                  return types.push(e.id);
                });
                _this13.edit.document_types = types !== null && types !== void 0 ? types : [];
              case 20:
              case "end":
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.$t("companyModule.table")))]), _vm._v(" "), _c("div", {
    ...
    staticClass: "mb-1",
    attrs: {
      value: _vm.$i18n.locale == "ar" ? "module.name" : "module.name_e"
    },
    model: {
      value: _vm.filterSetting,
      callback: function callback($$v) {
    ...
    attrs: {
      ...
      "custom-label": function customLabel(opt) {
        return _vm.$i18n.locale == "ar" ? _vm.modules.find(function (x) {
          return x.id == opt;
        }).name : _vm.modules.find(function (x) {
          return x.id == opt;
        }).name_e;
      }
    },
    ...
    model: {
      value: _vm.$v.create.menu_id.$model,
      callback: function callback($$v) {
        _vm.$set(_vm.$v.create.menu_id, "$model", $$v);
      },
      expression: "$v.create.menu_id.$model"
    }
  }), _vm._v(" "), !_vm.$v.create.menu_id.required ? _c("div", {
    staticClass: "invalid-feedback"
  }, [_vm._v("\n                        " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                      ")]) : _vm._e(), _vm._v(" "), _vm.errors.menu_id ? _vm._l(_vm.errors.name, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage) + "\n                        ")]);
  }) : _vm._e()], 2)]), _vm._v(" "), _c("div", {
    ...
    return _c("tr", {
    ...
    })])]) : _vm._e(), _vm._v(" "), _vm.setting.company_id ? _c("td", [_vm._v("\n                      " + _vm._s(_vm.$i18n.locale == "ar" ? data.company.name : data.company.name_e) + "\n                    ")]) : _vm._e(), _vm._v(" "), _vm.setting.module_id ? _c("td", [_vm._v("\n                      " + _vm._s(_vm.$i18n.locale == "ar" ? data.module.name : data.module.name_e) + "\n                    ")]) : _vm._e(), _vm._v(" "), _vm.setting.allowed_users_no ? _c("td", [_vm._v(_vm._s(data.allowed_users_no))]) : _vm._e(), _vm._v(" "), _vm.setting.start_date ? _c("td", [_vm._v(_vm._s(_vm.formatDate(data.start_date)))]) : _vm._e(), _vm._v(" "), _vm.setting.end_date ? _c("td", [_vm._v(_vm._s(data.end_date ? _vm.formatDate(data.end_date) : null))]) : _vm._e(), _vm._v(" "), _vm.enabled3 ? _c("td", {
      staticClass: "do-not-print"
    }, [_c("div", {
      ...
      attrs: {
        ...
        title: _vm.$t("companyModule.edit"),
        "title-class": "font-18",
        "body-class": "p-4",
        "hide-footer": true
      },
      ...
      model: {
        value: _vm.$v.edit.menu_id.$model,
        callback: function callback($$v) {
          _vm.$set(_vm.$v.edit.menu_id, "$model", $$v);
        },
        expression: "$v.edit.menu_id.$model"
      }
