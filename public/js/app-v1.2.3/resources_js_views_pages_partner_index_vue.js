...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  validations: {
    create: {
      ...
      password: {
        ...
        maxLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_12__.maxLength)(16)
      },
      repeatPassword: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_12__.required,
        sameAs: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_12__.sameAs)("password")
      },
      mobile_no: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_12__.required,
    ...
    createCompany: {
      ...
      tax_id: {
        minValue: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_12__.minValue)(0)
      },
      vat_no: {
        minValue: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_12__.minValue)(0)
      },
      ...
      address: {
        minLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_12__.minLength)(0),
        maxLength: (0,vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_12__.maxLength)(200)
      },
      partner_id: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_12__.required,
  ...
  methods: {
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid && !this.isVaildPhone) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/partners", this.create).then(function (res) {
          _this9.partner_id = res.data.data.id;
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid && !this.isVaildPhone) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].put("/partners/".concat(id), this.edit).then(function (res) {
          _this10.partner_id = res.data.data.id;
          setTimeout(function () {
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
              icon: "success",
    ...
    ExportExcel: function ExportExcel(type, fn, dl) {
      ...
      setTimeout(function () {
        ...
        if (dl) {
          ...
          XLSX.writeFile(wb, fn || ('Partner' + '.' || 0) + (type || 'xlsx'));
        }
    ...
    arabicValueCompany: function arabicValueCompany(txt) {
      this.createCompany.name = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_9__.arabicValue)(txt);
      this.editCompany.name = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_9__.arabicValue)(txt);
    },
    englishValueCompany: function englishValueCompany(txt) {
      this.createCompany.name_e = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_9__.englishValue)(txt);
      this.editCompany.name_e = (0,_helper_langTransform__WEBPACK_IMPORTED_MODULE_9__.englishValue)(txt);
    },
    ...
    deleteImageCreate: function deleteImageCreate(id, index) {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/companies/".concat(this.company_id), {
        ...
        _this14.companies[index] = res.data.data;
    ...
    updatePhoneCom: function updatePhoneCom(e) {
      this.createCompany.phone_code = e.countryCallingCode;
      this.createCompany.country_code = e.countryCode;
      this.isVaildPhone = e.isValid;
    },
    updatePhoneComEdit: function updatePhoneComEdit(e) {
      // this.editCompany.phone_code = e.countryCallingCode;
      // this.isVaildPhone = e.isValid;
    },
    updateContactPersonCom: function updateContactPersonCom(e) {
      this.createCompany.phone_code = e.countryCallingCode;
      this.createCompany.country_code = e.countryCode;
      this.isVaildPhone = e.isValid;
    },
    updateContactPersonComEdit: function updateContactPersonComEdit(e) {
      // this.editCompany.phone_code = e.countryCallingCode;
      // this.editCompany = e.isValid;
    },
    resetFormCom: function resetFormCom() {
      var _this15 = this;
      this.createCompany = {
        name: "",
        name_e: "",
    ...
    AddSubmitCom: function AddSubmitCom() {
      var _this16 = this;
      ...
      if (this.$v.createCompany.$invalid && !this.isVaildPhone) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/companies", _objectSpread(_objectSpread({}, this.createCompany), {}, {
          url: this.createCompany.website,
          website: undefined
        })).then(function (res) {
          _this16.is_disabledCom = true;
          _this16.company_id = res.data.data.id;
          setTimeout(function () {
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
              icon: "success",
          ...
          if (type == 'edit') {
            _this16.getDataCompany();
          } else {
            _this16.getAllModules();
            _this16.docType();
          }
        })["catch"](function (err) {
          if (err.response.data) {
    ...
    editSubmitCom: function editSubmitCom(id, index) {
      var _this17 = this;
      ...
      if (this.images) this.images.forEach(function (e) {
        _this17.editCompany.old_media.push(e.id);
      });
      if (this.$v.editCompany.$invalid && !this.isVaildPhone) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].put("/companies/".concat(id), _objectSpread(_objectSpread({}, this.editCompany), {}, {
          url: this.editCompany.website,
          website: undefined
        })).then(function (res) {
          _this17.getDataCompany();
          setTimeout(function () {
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
              icon: "success",
    ...
    start_date: function start_date(e) {
      if (e) {
        this.createProgram.start_date = (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_8__.formatDateTime)(e);
      } else {
    ...
    end_date: function end_date(e) {
      if (e) {
        this.createProgram.end_date = (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_8__.formatDateTime)(e);
      } else {
    ...
    resetFormProgram: function resetFormProgram() {
      var _this20 = this;
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      this.createProgram = {
        out_site: "",
    ...
    AddSubmitProgram: function AddSubmitProgram() {
      var _this21 = this;
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      if (type == 'edit') {
      ...
      if (this.$v.createProgram.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/company-project-program-modules", _objectSpread(_objectSpread({}, this.createProgram), {}, {
          module_id: undefined,
          project_program_module_id: this.createProgram.module_id
        })).then(function (res) {
          _this21.is_disabledProgram = true;
          setTimeout(function () {
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
              icon: "success",
              text: "".concat(_this21.$t("general.Addedsuccessfully")),
              showConfirmButton: false,
              timer: 1500
            });
          }, 500);
          if (type == 'edit') {
            _this21.getDataProgram();
          }
        })["catch"](function (err) {
          if (err.response.data) {
    ...
    getDataCompany: function getDataCompany() {
      var _this22 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/companies?partner_id=".concat(this.partner_id)).then(function (res) {
        var l = res.data;
        _this22.companies = l.data;
      })["catch"](function (err) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
          icon: "error",
    ...
    resetModalComEdit: function resetModalComEdit(id) {
      var _company$media;
      ...
      this.errors = {};
      this.images = (_company$media = company.media) !== null && _company$media !== void 0 ? _company$media : [];
    ...
    resetModalHiddenComEdit: function resetModalHiddenComEdit(id) {
      this.editCompany = {
        name: "",
        name_e: "",
        email: "",
    ...
    getDataProgram: function getDataProgram() {
      var _this23 = this;
      this.isLoader = true;
      var company_ids = this.companies.map(function (el) {
        return el.id;
      });
      var filter = '';
      for (var i = 0; i < company_ids.length; ++i) {
        filter += "company_ids[".concat(i, "]=").concat(company_ids[i], "&");
      }
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/company-project-program-modules?".concat(filter)).then(function (res) {
        var l = res.data;
        _this23.companyModules = l.data;
      })["catch"](function (err) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
          icon: "error",
    ...
    resetModalProgramEdit: function resetModalProgramEdit(id) {
      var _this24 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                companyModule = _this24.companyModules.find(function (e) {
                  return id == e.id;
                });
                _context3.next = 3;
                return _this24.getAllModules();
              case 3:
                _context3.next = 5;
                return _this24.docType();
              case 5:
                _this24.editProgram.company_id = companyModule.company.id;
                _this24.editProgram.module_id = companyModule.project_program_module.id;
                _this24.editProgram.allowed_users_no = companyModule.allowed_users_no;
                _this24.editProgram.out_site = companyModule.out_site;
                _this24.editProgram.allowed_employee = companyModule.allowed_employee;
                _this24.editProgram.custom_date_start = new Date(companyModule.start_date);
                _this24.editProgram.is_web = companyModule.is_web;
                _this24.editProgram.custom_date_end = companyModule.end_date ? new Date(companyModule.end_date) : null;
                _this24.editProgram.start_date = (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_8__.formatDateTime)(companyModule.start_date);
                _this24.editProgram.end_date = companyModule.end_date ? (0,_helper_startDate__WEBPACK_IMPORTED_MODULE_8__.formatDateTime)(companyModule.end_date) : null;
                types = [];
                companyModule.document_types.forEach(function (e) {
                  return types.push(e.id);
                });
                _this24.editProgram.document_types = types !== null && types !== void 0 ? types : [];
              case 18:
              case "end":
    ...
    resetModalHiddenProgramEdit: function resetModalHiddenProgramEdit() {
      this.editProgram = {
        out_site: "",
        allowed_employee: "",
        company_id: "",
    ...
    editSubmitProgram: function editSubmitProgram(id) {
      var _this25 = this;
      ...
      if (this.$v.editProgram.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].put("/company-project-program-modules/".concat(id), _objectSpread(_objectSpread({}, this.editProgram), {}, {
          module_id: undefined,
          ...
          setTimeout(function () {
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default().fire({
              icon: "success",
              text: "".concat(_this25.$t("general.Editsuccessfully")),
              showConfirmButton: false,
              timer: 1500
            });
          }, 500);
          _this25.getDataProgram();
        })["catch"](function (err) {
          if (err.response.data) {
...
/* harmony export */   "staticRenderFns": () => (/* binding */ staticRenderFns)
/* harmony export */ });
function _typeof(obj){"@babel/helpers - typeof";return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(obj){return typeof obj;}:function(obj){return obj&&"function"==typeof Symbol&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;},_typeof(obj);}function _defineProperty(obj,key,value){key=_toPropertyKey(key);if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else{obj[key]=value;}return obj;}function _toPropertyKey(arg){var key=_toPrimitive(arg,"string");return _typeof(key)==="symbol"?key:String(key);}function _toPrimitive(input,hint){if(_typeof(input)!=="object"||input===null)return input;var prim=input[Symbol.toPrimitive];if(prim!==undefined){var res=prim.call(input,hint||"default");if(_typeof(res)!=="object")return res;throw new TypeError("@@toPrimitive must return a primitive value.");}return(hint==="string"?String:Number)(input);}var render=function render(){var _vm=this,_c=_vm._self._c;return _c("Layout",[_c("PageHeader"),_vm._v(" "),_c("div",{staticClass:"row no-gutters"},[_c("div",{staticClass:"col-12"},[_c("div",{staticClass:"card"},[_c("div",{staticClass:"card-body"},[_c("div",{staticClass:"row justify-content-between align-items-center mb-2"},[_c("h4",{staticClass:"header-title"},[_vm._v(_vm._s(_vm.$t("partner.partnersTable")))]),_vm._v(" "),_c("div",{staticClass:"col-xs-10 col-md-9 col-lg-7",staticStyle:{"font-weight":"500"}},[_c("div",{staticClass:"d-inline-block",staticStyle:{width:"22.2%"}},[_c("b-dropdown",{ref:"dropdown",staticClass:"btn-block setting-search",attrs:{variant:"primary",text:_vm.$t("general.searchSetting")}},[_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:"name"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v(_vm._s(_vm.$t("general.Name")))]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:"name_e"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v(_vm._s(_vm.$t("general.Name_en")))]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:"email"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v(_vm._s(_vm.$t("login.Emailaddress")))]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:"mobile_no"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v(_vm._s(_vm.$t("general.mobile_no")))])],1)],1),_vm._v(" "),_c("div",{staticClass:"d-inline-block position-relative",staticStyle:{width:"77%"}},[_c("span",{"class":["search-custom position-absolute",_vm.$i18n.locale=="ar"?"search-custom-ar":""]},[_c("i",{staticClass:"fe-search"})]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.search,expression:"search",modifiers:{trim:true}}],staticClass:"form-control",staticStyle:{display:"block",width:"93%","padding-top":"3px"},attrs:{type:"text",placeholder:"".concat(_vm.$t("general.Search"),"...")},domProps:{value:_vm.search},on:{input:function input($event){if($event.target.composing)return;_vm.search=$event.target.value.trim();},blur:function blur($event){return _vm.$forceUpdate();}}})])])]),_vm._v(" "),_c("div",{staticClass:"row justify-content-between align-items-center mb-2 px-1"},[_c("div",{staticClass:"col-md-3 d-flex align-items-center mb-1 mb-xl-0"},[_c("b-button",{directives:[{name:"b-modal",rawName:"v-b-modal.create",modifiers:{create:true}}],staticClass:"btn-sm mx-1 font-weight-bold",attrs:{variant:"primary"}},[_vm._v("\n                "+_vm._s(_vm.$t("general.Create"))+"\n                "),_c("i",{staticClass:"fas fa-plus"})]),_vm._v(" "),_c("div",{staticClass:"d-inline-flex"},[_c("button",{staticClass:"custom-btn-dowonload",on:{click:function click($event){return _vm.ExportExcel("xlsx");}}},[_c("i",{staticClass:"fas fa-file-download"})]),_vm._v(" "),_c("button",{directives:[{name:"print",rawName:"v-print",value:"#printMe",expression:"'#printMe'"}],staticClass:"custom-btn-dowonload"},[_c("i",{staticClass:"fe-printer"})]),_vm._v(" "),_vm.checkAll.length==1?_c("button",{staticClass:"custom-btn-dowonload",on:{click:function click($event){return _vm.$bvModal.show("modal-edit-".concat(_vm.checkAll[0]));}}},[_c("i",{staticClass:"mdi mdi-square-edit-outline"})]):_vm._e(),_vm._v(" "),_vm.checkAll.length>1?_c("button",{staticClass:"custom-btn-dowonload",on:{click:function click($event){$event.preventDefault();return _vm.deletePartner(_vm.checkAll);}}},[_c("i",{staticClass:"fas fa-trash-alt"})]):_vm._e(),_vm._v(" "),_vm.checkAll.length==1?_c("button",{staticClass:"custom-btn-dowonload",on:{click:function click($event){$event.preventDefault();return _vm.deletePartner(_vm.checkAll[0]);}}},[_c("i",{staticClass:"fas fa-trash-alt"})]):_vm._e()])],1),_vm._v(" "),_c("div",{staticClass:"col-xs-10 col-md-9 col-lg-7 d-flex align-items-center justify-content-end"},[_c("div",[_c("b-button",{staticClass:"mx-1 custom-btn-background"},[_vm._v("\n                  "+_vm._s(_vm.$t("general.filter"))+"\n                  "),_c("i",{staticClass:"fas fa-filter"})]),_vm._v(" "),_c("b-button",{staticClass:"mx-1 custom-btn-background"},[_vm._v("\n                  "+_vm._s(_vm.$t("general.group"))+"\n                  "),_c("i",{staticClass:"fe-menu"})]),_vm._v(" "),_c("b-dropdown",{ref:"dropdown",staticClass:"dropdown-custom-ali",attrs:{variant:"primary",html:"".concat(_vm.$t("general.setting")," <i class='fe-settings'></i>")}},[_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.name,callback:function callback($$v){_vm.$set(_vm.setting,"name",$$v);},expression:"setting.name"}},[_vm._v(_vm._s(_vm.$t("general.Name"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.name_e,callback:function callback($$v){_vm.$set(_vm.setting,"name_e",$$v);},expression:"setting.name_e"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.Name_en"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.mobile_no,callback:function callback($$v){_vm.$set(_vm.setting,"mobile_no",$$v);},expression:"setting.mobile_no"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.mobile_no"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.email,callback:function callback($$v){_vm.$set(_vm.setting,"email",$$v);},expression:"setting.email"}},[_vm._v("\n                    "+_vm._s(_vm.$t("login.Emailaddress"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.is_active,callback:function callback($$v){_vm.$set(_vm.setting,"is_active",$$v);},expression:"setting.is_active"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.Status"))+"\n                  ")]),_vm._v(" "),_c("div",{staticClass:"d-flex justify-content-end"},[_c("a",{staticClass:"btn btn-primary btn-sm",attrs:{href:"javascript:void(0)"}},[_vm._v("Apply")])])],1),_vm._v(" "),_c("div",{staticClass:"d-inline-flex align-items-center pagination-custom"},[_c("div",{staticClass:"d-inline-block",staticStyle:{"font-size":"15px"}},[_vm._v("\n                    "+_vm._s(_vm.partnersPagination.from)+"-"+_vm._s(_vm.partnersPagination.to)+" /\n                    "+_vm._s(_vm.partnersPagination.total)+"\n                  ")]),_vm._v(" "),_c("div",{staticClass:"d-inline-block"},[_c("a",{style:{"pointer-events":_vm.partnersPagination.current_page==1?"none":""},attrs:{href:"javascript:void(0)"},on:{click:function click($event){$event.preventDefault();return _vm.getData(_vm.partnersPagination.current_page-1);}}},[_c("span",[_vm._v("<")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model",value:_vm.current_page,expression:"current_page"}],staticClass:"pagination-current-page",attrs:{type:"text"},domProps:{value:_vm.current_page},on:{keyup:function keyup($event){if(!$event.type.indexOf("key")&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter"))return null;return _vm.getDataCurrentPage();},input:function input($event){if($event.target.composing)return;_vm.current_page=$event.target.value;}}}),_vm._v(" "),_c("a",{style:{"pointer-events":_vm.partnersPagination.last_page==_vm.partnersPagination.current_page?"none":""},attrs:{href:"javascript:void(0)"},on:{click:function click($event){$event.preventDefault();return _vm.getData(_vm.partnersPagination.current_page+1);}}},[_c("span",[_vm._v(">")])])])])],1)])]),_vm._v(" "),_c("b-modal",{attrs:{id:"create",title:_vm.$t("partner.addpartner"),"title-class":"font-18","dialog-class":"modal-full-width","body-class":"p-4","hide-footer":true},on:{show:_vm.resetModal,hidden:_vm.resetModalHidden}},[_c("form",[_c("div",{staticClass:"mb-3 d-flex justify-content-end"},[_c("b-button",{"class":["font-weight-bold px-2",!_vm.is_disabled?"":"mx-2"],attrs:{variant:"success",disabled:!_vm.is_disabled,type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.resetForm.apply(null,arguments);}}},[_vm._v("\n                  "+_vm._s(_vm.$t("general.AddNewRecord"))+"\n                ")]),_vm._v(" "),!_vm.is_disabled?[!_vm.isLoader?_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.AddSubmit.apply(null,arguments);}}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.Add"))+"\n                  ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1)]:_vm._e(),_vm._v(" "),_c("b-button",{attrs:{variant:"danger",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.$bvModal.hide("create");}}},[_vm._v("\n                  "+_vm._s(_vm.$t("general.Cancel"))+"\n                ")])],2),_vm._v(" "),_c("b-tabs",{attrs:{"nav-class":"nav-tabs nav-bordered"}},[_c("b-tab",{attrs:{title:_vm.$t("general.DataEntry"),active:""}},[_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-6 direction",attrs:{dir:"rtl"}},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-1"}},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Name"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.create.name.$model,expression:"$v.create.name.$model",modifiers:{trim:true}}],staticClass:"form-control arabicInput","class":{"is-invalid":_vm.$v.create.name.$error||_vm.errors.name,"is-valid":!_vm.$v.create.name.$invalid&&!_vm.errors.name},attrs:{type:"text",id:"field-1"},domProps:{value:_vm.$v.create.name.$model},on:{keyup:function keyup($event){return _vm.arabicValue(_vm.create.name);},input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.create.name,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.create.name.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                        "+_vm._s(_vm.$v.create.name.$params.minLength.min)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.create.name.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                        "+_vm._s(_vm.$v.create.name.$params.maxLength.max)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.create.name.alphaArabic?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.alphaArabic"))+"\n                                    ")]):_vm._e(),_vm._v(" "),_vm.errors.name?_vm._l(_vm.errors.name,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6 direction-ltr",attrs:{dir:"ltr"}},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-2"}},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Name_en"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.create.name_e.$model,expression:"$v.create.name_e.$model",modifiers:{trim:true}}],staticClass:"form-control englishInput","class":{"is-invalid":_vm.$v.create.name_e.$error||_vm.errors.name_e,"is-valid":!_vm.$v.create.name_e.$invalid&&!_vm.errors.name_e},attrs:{type:"text",id:"field-2"},domProps:{value:_vm.$v.create.name_e.$model},on:{keyup:function keyup($event){return _vm.englishValue(_vm.create.name_e);},input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.create.name_e,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.create.name_e.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                        "+_vm._s(_vm.$v.create.name_e.$params.minLength.min)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.create.name_e.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                        "+_vm._s(_vm.$v.create.name_e.$params.maxLength.max)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.create.name_e.alphaEnglish?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.alphaEnglish"))+"\n                                    ")]):_vm._e(),_vm._v(" "),_vm.errors.name_e?_vm._l(_vm.errors.name_e,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-3"}},[_vm._v("\n                                        "+_vm._s(_vm.$t("login.Emailaddress"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.create.email.$model,expression:"$v.create.email.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.create.email.$error||_vm.errors.email,"is-valid":!_vm.$v.create.email.$invalid&&!_vm.errors.email},attrs:{type:"email",id:"field-3"},domProps:{value:_vm.$v.create.email.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.create.email,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.create.email.email?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.PleaseEnterValidEmail"))+"\n                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.create.email.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                        "+_vm._s(_vm.$v.create.email.$params.minLength.min)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.create.email.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                        "+_vm._s(_vm.$v.create.email.$params.maxLength.max)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                    ")]):_vm._e(),_vm._v(" "),_vm.errors.email?_vm._l(_vm.errors.email,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.mobile_no"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("VuePhoneNumberInput",{attrs:{"default-country-code":"KW","valid-color":"#28a745","error-color":"#dc3545","preferred-countries":["FR","EG","DE"]},on:{update:_vm.updatePhone},model:{value:_vm.$v.create.mobile_no.$model,callback:function callback($$v){_vm.$set(_vm.$v.create.mobile_no,"$model",$$v);},expression:"$v.create.mobile_no.$model"}}),_vm._v(" "),_vm.errors.mobile_no?_vm._l(_vm.errors.mobile_no,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("div",{staticClass:"d-flex justify-content-between align-items-center"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-5"}},[_vm._v("\n                                            "+_vm._s(_vm.$t("login.Password"))+"\n                                            "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("i",{"class":["fas custom-eye",!_vm.isEye?"fa-eye-slash":"fas fa-eye active"],on:{click:function click($event){_vm.isEye=!_vm.isEye;}}})]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.create.password.$model,expression:"$v.create.password.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.create.password.$error||_vm.errors.password,"is-valid":!_vm.$v.create.password.$invalid&&!_vm.errors.password},attrs:{type:!_vm.isEye?"password":"text",id:"field-5"},domProps:{value:_vm.$v.create.password.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.create.password,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.create.password.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                        "+_vm._s(_vm.$v.create.password.$params.minLength.min)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.create.password.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                        "+_vm._s(_vm.$v.create.password.$params.maxLength.max)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                    ")]):_vm._e(),_vm._v(" "),_vm.errors.password?_vm._l(_vm.errors.password,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-6"}},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.repeatPassword"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.create.repeatPassword.$model,expression:"$v.create.repeatPassword.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.create.repeatPassword.$error||_vm.errors.repeatPassword,"is-valid":!_vm.$v.create.repeatPassword.$invalid&&!_vm.errors.repeatPassword},attrs:{type:"password",id:"field-6"},domProps:{value:_vm.$v.create.repeatPassword.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.create.repeatPassword,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.create.repeatPassword.sameAs?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.samaAs"))+"\n                                    ")]):_vm._e(),_vm._v(" "),_vm.errors.repeatPassword?_vm._l(_vm.errors.repeatPassword,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"mr-2 mb-2"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Status"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("b-form-group",[_c("b-form-radio",{staticClass:"d-inline-block",attrs:{name:"some-radios-dd",value:"active"},model:{value:_vm.$v.create.is_active.$model,callback:function callback($$v){_vm.$set(_vm.$v.create.is_active,"$model",$$v);},expression:"$v.create.is_active.$model"}},[_vm._v(_vm._s(_vm.$t("general.Active")))]),_vm._v(" "),_c("b-form-radio",{staticClass:"d-inline-block m-1",attrs:{name:"some-radios-dd",value:"inactive"},model:{value:_vm.$v.create.is_active.$model,callback:function callback($$v){_vm.$set(_vm.$v.create.is_active,"$model",$$v);},expression:"$v.create.is_active.$model"}},[_vm._v(_vm._s(_vm.$t("general.Inactive")))])],1),_vm._v(" "),_vm.errors.is_active?_vm._l(_vm.errors.is_active,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                        ")]);}):_vm._e()],2)])])]),_vm._v(" "),_c("b-tab",{attrs:{title:_vm.$t("company.company"),disabled:!_vm.partner_id}},[_c("div",{staticClass:"mt-1 d-flex justify-content-end"},[_c("b-button",{"class":["font-weight-bold px-2",_vm.is_disabledCom?"mx-2":""],attrs:{variant:"success",disabled:!_vm.is_disabledCom,type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.resetFormCom.apply(null,arguments);}}},[_vm._v("\n                                "+_vm._s(_vm.$t("general.AddNewRecord"))+"\n                            ")]),_vm._v(" "),!_vm.is_disabledCom?[!_vm.isLoader?_c("b-button",{staticClass:"mx-1 font-weight-bold px-3",attrs:{variant:"success",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.AddSubmitCom.apply(null,arguments);}}},[_vm._v("\n                                    "+_vm._s(_vm.$t("general.Save"))+"\n                                ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1)]:_vm._e()],2),_vm._v(" "),_c("div",{staticClass:"row justify-content-between"},[_c("div",{staticClass:"col-7"},[_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-6 direction",attrs:{dir:"rtl"}},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-1"}},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Name"))+"\n                                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.createCompany.name.$model,expression:"$v.createCompany.name.$model",modifiers:{trim:true}}],staticClass:"form-control arabicInput","class":{"is-invalid":_vm.$v.createCompany.name.$error||_vm.errors.name,"is-valid":!_vm.$v.createCompany.name.$invalid&&!_vm.errors.name},attrs:{type:"text"},domProps:{value:_vm.$v.createCompany.name.$model},on:{keyup:function keyup($event){return _vm.arabicValueCompany(_vm.createCompany.name);},input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.name,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.createCompany.name.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                "+_vm._s(_vm.$v.createCompany.name.$params.minLength.min)+"\n                                                "+_vm._s(_vm.$t("general.letters"))+"\n                                            ")]):_vm._e(),_vm._v(" "),!_vm.$v.createCompany.name.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                "+_vm._s(_vm.$v.createCompany.name.$params.maxLength.max)+"\n                                                "+_vm._s(_vm.$t("general.letters"))+"\n                                            ")]):_vm._e(),_vm._v(" "),_vm.errors.name?_vm._l(_vm.errors.name,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6 direction-ltr",attrs:{dir:"ltr"}},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-2"}},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Name_en"))+"\n                                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.createCompany.name_e.$model,expression:"$v.createCompany.name_e.$model",modifiers:{trim:true}}],staticClass:"form-control englishInput","class":{"is-invalid":_vm.$v.createCompany.name_e.$error||_vm.errors.name_e,"is-valid":!_vm.$v.createCompany.name_e.$invalid&&!_vm.errors.name_e},attrs:{type:"text",id:"field-2"},domProps:{value:_vm.$v.createCompany.name_e.$model},on:{keyup:function keyup($event){return _vm.englishValueCompany(_vm.createCompany.name_e);},input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.name_e,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.createCompany.name_e.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                "+_vm._s(_vm.$v.createCompany.name_e.$params.minLength.min)+"\n                                                "+_vm._s(_vm.$t("general.letters"))+"\n                                            ")]):_vm._e(),_vm._v(" "),!_vm.$v.createCompany.name_e.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                "+_vm._s(_vm.$v.createCompany.name_e.$params.maxLength.max)+"\n                                                "+_vm._s(_vm.$t("general.letters"))+"\n                                            ")]):_vm._e(),_vm._v(" "),_vm.errors.name_e?_vm._l(_vm.errors.name_e,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-3"}},[_vm._v("\n                                                "+_vm._s(_vm.$t("login.Emailaddress"))+"\n                                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.createCompany.email.$model,expression:"$v.createCompany.email.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createCompany.email.$error||_vm.errors.email,"is-valid":!_vm.$v.createCompany.email.$invalid&&!_vm.errors.email},attrs:{type:"email",id:"field-3"},domProps:{value:_vm.$v.createCompany.email.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.email,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.createCompany.email.email?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.PleaseEnterValidEmail"))+"\n                                            ")]):_vm._e(),_vm._v(" "),!_vm.$v.createCompany.email.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                "+_vm._s(_vm.$v.createCompany.email.$params.minLength.min)+"\n                                                "+_vm._s(_vm.$t("general.letters"))+"\n                                            ")]):_vm._e(),_vm._v(" "),!_vm.$v.createCompany.email.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                "+_vm._s(_vm.$v.createCompany.email.$params.maxLength.max)+"\n                                                "+_vm._s(_vm.$t("general.letters"))+"\n                                            ")]):_vm._e(),_vm._v(" "),_vm.errors.email?_vm._l(_vm.errors.email,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-12"}},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.address"))+"\n                                            ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.createCompany.address.$model,expression:"$v.createCompany.address.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createCompany.address.$error||_vm.errors.address,"is-valid":!_vm.$v.createCompany.address.$invalid&&!_vm.errors.address},attrs:{type:"text",id:"field-12"},domProps:{value:_vm.$v.createCompany.address.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.address,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.createCompany.address.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                "+_vm._s(_vm.$v.createCompany.address.$params.minLength.min)+"\n                                                "+_vm._s(_vm.$t("general.letters"))+"\n                                            ")]):_vm._e(),_vm._v(" "),!_vm.$v.createCompany.address.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                "+_vm._s(_vm.$v.createCompany.address.$params.maxLength.max)+"\n                                                "+_vm._s(_vm.$t("general.letters"))+"\n                                            ")]):_vm._e(),_vm._v(" "),_vm.errors.address?_vm._l(_vm.errors.address,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.mobile_no"))+"\n                                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("VuePhoneNumberInput",{attrs:{"default-country-code":"KW","valid-color":"#28a745","error-color":"#dc3545","preferred-countries":["FR","EG","DE"]},on:{update:_vm.updatePhoneCom},model:{value:_vm.$v.createCompany.phone.$model,callback:function callback($$v){_vm.$set(_vm.$v.createCompany.phone,"$model",$$v);},expression:"$v.createCompany.phone.$model"}}),_vm._v(" "),_vm.errors.phone?_vm._l(_vm.errors.phone,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.contact_person"))+"\n                                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("VuePhoneNumberInput",{attrs:{"default-country-code":"KW","valid-color":"#28a745","error-color":"#dc3545","preferred-countries":["FR","EG","DE"]},on:{update:_vm.updateContactPersonCom},model:{value:_vm.$v.createCompany.contact_person.$model,callback:function callback($$v){_vm.$set(_vm.$v.createCompany.contact_person,"$model",$$v);},expression:"$v.createCompany.contact_person.$model"}}),_vm._v(" "),_vm.errors.contact_person?_vm._l(_vm.errors.contact_person,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-11"}},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.website"))+"\n                                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.createCompany.website.$model,expression:"$v.createCompany.website.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createCompany.website.$error||_vm.errors.website,"is-valid":!_vm.$v.createCompany.website.$invalid&&!_vm.errors.website},attrs:{type:"url",id:"field-11"},domProps:{value:_vm.$v.createCompany.website.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.website,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.createCompany.website.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                "+_vm._s(_vm.$v.createCompany.website.$params.minLength.min)+"\n                                                "+_vm._s(_vm.$t("general.letters"))+"\n                                            ")]):_vm._e(),_vm._v(" "),!_vm.$v.createCompany.website.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                "+_vm._s(_vm.$v.createCompany.website.$params.maxLength.max)+"\n                                                "+_vm._s(_vm.$t("general.letters"))+"\n                                            ")]):_vm._e(),_vm._v(" "),!_vm.$v.createCompany.website.url?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Itmustbeyourlink"))+"\n                                            ")]):_vm._e(),_vm._v(" "),_vm.errors.website?_vm._l(_vm.errors.website,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)])])]),_vm._v(" "),_c("div",{staticClass:"col-4"},[_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-6",staticStyle:{height:"67.6px"}}),_vm._v(" "),_c("div",{staticClass:"col-md-6",staticStyle:{height:"67.6px"}}),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-5"}},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.taxnumber"))+"\n                                            ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.createCompany.tax_id.$model,expression:"$v.createCompany.tax_id.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createCompany.tax_id.$error||_vm.errors.tax_id,"is-valid":!_vm.$v.createCompany.tax_id.$invalid&&!_vm.errors.tax_id},attrs:{min:"0",type:"number",id:"field-5"},domProps:{value:_vm.$v.createCompany.tax_id.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.tax_id,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.tax_id?_vm._l(_vm.errors.tax_id,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-8"}},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.CommercialRecord"))+"\n                                            ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.createCompany.cr.$model,expression:"$v.createCompany.cr.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createCompany.cr.$error||_vm.errors.cr,"is-valid":!_vm.$v.createCompany.cr.$invalid&&!_vm.errors.cr},attrs:{type:"text",id:"field-8"},domProps:{value:_vm.$v.createCompany.cr.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.cr,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.cr?_vm._l(_vm.errors.cr,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",staticStyle:{"font-size":"10px"},attrs:{"for":"field-6"}},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Valueaddedregistrationnumber"))+"\n                                            ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.createCompany.vat_no.$model,expression:"$v.createCompany.vat_no.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createCompany.vat_no.$error||_vm.errors.vat_no,"is-valid":!_vm.$v.createCompany.vat_no.$invalid&&!_vm.errors.vat_no},attrs:{type:"number",id:"field-6"},domProps:{value:_vm.$v.createCompany.vat_no.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.vat_no,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.vat_no?_vm._l(_vm.errors.vat_no,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"mr-2"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Status"))+"\n                                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("b-form-group",{"class":{"is-invalid":_vm.$v.createCompany.is_active.$error||_vm.errors.is_active,"is-valid":!_vm.$v.createCompany.is_active.$invalid&&!_vm.errors.is_active}},[_c("b-form-radio",{staticClass:"d-inline-block",attrs:{name:"some-radio-pp",value:"active"},model:{value:_vm.$v.createCompany.is_active.$model,callback:function callback($$v){_vm.$set(_vm.$v.createCompany.is_active,"$model",$$v);},expression:"$v.createCompany.is_active.$model"}},[_vm._v(_vm._s(_vm.$t("general.Active")))]),_vm._v(" "),_c("b-form-radio",{staticClass:"d-inline-block m-1",attrs:{name:"some-radio-pp",value:"inactive"},model:{value:_vm.$v.createCompany.is_active.$model,callback:function callback($$v){_vm.$set(_vm.$v.createCompany.is_active,"$model",$$v);},expression:"$v.createCompany.is_active.$model"}},[_vm._v(_vm._s(_vm.$t("general.Inactive")))])],1),_vm._v(" "),_vm.errors.is_active?_vm._l(_vm.errors.is_active,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                                ")]);}):_vm._e()],2)])])])])]),_vm._v(" "),_c("b-tab",{attrs:{disabled:!_vm.company_id,title:_vm.$t("company.LogoFileUpload")}},[_c("div",{staticClass:"row"},[_c("input",{staticClass:"input-file-upload position-absolute d-none",attrs:{accept:"image/png, image/gif, image/jpeg, image/jpg",type:"file",id:"uploadImageCreate"},on:{change:function change($event){$event.preventDefault();return _vm.onImageChanged.apply(null,arguments);}}}),_vm._v(" "),_c("div",{staticClass:"col-md-8 my-1"},[_c("div",{staticClass:"row align-content-between",staticStyle:{width:"100%",height:"100%"}},[_c("div",{staticClass:"col-12"},[_c("div",{staticClass:"d-flex flex-wrap"},_vm._l(_vm.images,function(photo,index){return _c("div",{key:photo.id,"class":["dropzone-previews col-4 position-relative mb-2"]},[_c("div",{"class":["card mb-0 shadow-none border",_vm.images.length-1==index?"bg-primary":""]},[_c("div",{staticClass:"p-2"},[_c("div",{staticClass:"row align-items-center"},[_c("div",{staticClass:"col-auto",on:{click:function click($event){_vm.showPhoto=photo.webp;}}},[_c("img",{staticClass:"avatar-sm rounded bg-light",attrs:{"data-dz-thumbnail":"",src:photo.webp},on:{error:function error($event){_vm.src="./images/img-1.png";}}})]),_vm._v(" "),_c("div",{staticClass:"col pl-0"},[_c("a",{"class":["font-weight-bold",_vm.images.length-1==index?"text-white":"text-muted"],attrs:{href:"javascript:void(0);","data-dz-name":""}},[_vm._v("\n                                                                    "+_vm._s(photo.name)+"\n                                                                ")])]),_vm._v(" "),_c("a",{"class":["btn-danger dropzone-close",_vm.$i18n.locale=="ar"?"dropzone-close-rtl":""],attrs:{href:"javascript:void(0);","data-dz-remove":""},on:{click:function click($event){$event.preventDefault();return _vm.deleteImageCreate(photo.id,index);}}},[_c("i",{staticClass:"fe-x"})])])])])]);}),0)]),_vm._v(" "),_c("div",{staticClass:"footer-image col-12"},[!_vm.isLoader?_c("b-button",{staticClass:"mx-1 font-weight-bold px-3",attrs:{variant:"success",type:"button"},on:{click:_vm.changePhoto}},[_vm._v("\n                                            "+_vm._s(_vm.$t("general.Add"))+"\n                                        ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1)],1)])]),_vm._v(" "),_c("div",{staticClass:"col-md-4"},[_c("div",{staticClass:"show-dropzone"},[_c("img",{staticClass:"img-thumbnail",attrs:{src:_vm.showPhoto},on:{error:function error($event){_vm.src="./images/img-1.png";}}})])])])]),_vm._v(" "),_c("b-tab",{attrs:{title:_vm.$t("general.program"),disabled:!_vm.company_id}},[_c("div",{staticClass:"mb-2 d-flex justify-content-end"},[_c("b-button",{"class":["font-weight-bold px-2",_vm.is_disabledProgram?"mx-2":""],attrs:{variant:"success",disabled:!_vm.is_disabledProgram,type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.resetFormProgram.apply(null,arguments);}}},[_vm._v("\n                                "+_vm._s(_vm.$t("general.AddNewRecord"))+"\n                            ")]),_vm._v(" "),!_vm.is_disabledProgram?[!_vm.isLoader?_c("b-button",{staticClass:"mx-1 font-weight-bold px-3",attrs:{variant:"success",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.AddSubmitProgram.apply(null,arguments);}}},[_vm._v("\n                                    "+_vm._s(_vm.$t("general.Save"))+"\n                                ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1)]:_vm._e()],2),_vm._v(" "),_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-4"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                        "+_vm._s(_vm.$t("module.module"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("multiselect",{attrs:{options:_vm.modules.map(function(type){return type.id;}),"custom-label":function customLabel(opt){return _vm.modules.find(function(x){return x.id==opt;})?_vm.$i18n.locale=="ar"?"".concat(_vm.modules.find(function(x){return x.id==opt;}).parent.name,"|").concat(_vm.modules.find(function(x){return x.id==opt;}).name):"".concat(_vm.modules.find(function(x){return x.id==opt;}).parent.name_e,"|").concat(_vm.modules.find(function(x){return x.id==opt;}).name_e):null;}},model:{value:_vm.$v.createProgram.module_id.$model,callback:function callback($$v){_vm.$set(_vm.$v.createProgram.module_id,"$model",$$v);},expression:"$v.createProgram.module_id.$model"}}),_vm._v(" "),!_vm.$v.createProgram.module_id.required?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.fieldIsRequired"))+"\n                                    ")]):_vm._e(),_vm._v(" "),_vm.errors.module_id?_vm._l(_vm.errors.name,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                        ")]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-4"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.document_types"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("multiselect",{attrs:{multiple:true,options:_vm.document_types.map(function(type){return type.id;}),"custom-label":function customLabel(opt){return _vm.document_types.find(function(x){return x.id==opt;})?_vm.$i18n.locale=="ar"?_vm.document_types.find(function(x){return x.id==opt;}).name:_vm.document_types.find(function(x){return x.id==opt;}).name_e:null;}},model:{value:_vm.$v.createProgram.document_types.$model,callback:function callback($$v){_vm.$set(_vm.$v.createProgram.document_types,"$model",$$v);},expression:"$v.createProgram.document_types.$model"}}),_vm._v(" "),_vm.errors.document_types?_vm._l(_vm.errors.document_types,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-4"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.allowed_users_no"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.createProgram.allowed_users_no.$model,expression:"$v.createProgram.allowed_users_no.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createProgram.allowed_users_no.$error||_vm.errors.allowed_users_no,"is-valid":!_vm.$v.createProgram.allowed_users_no.$invalid&&!_vm.errors.allowed_users_no},attrs:{type:"number"},domProps:{value:_vm.$v.createProgram.allowed_users_no.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createProgram.allowed_users_no,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.allowed_users_no?_vm._l(_vm.errors.allowed_users_no,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-4"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.allowed_employee"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.createProgram.allowed_employee.$model,expression:"$v.createProgram.allowed_employee.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createProgram.allowed_employee.$error||_vm.errors.allowed_employee,"is-valid":!_vm.$v.createProgram.allowed_employee.$invalid&&!_vm.errors.allowed_employee},attrs:{type:"number"},domProps:{value:_vm.$v.createProgram.allowed_employee.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createProgram.allowed_employee,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.allowed_employee?_vm._l(_vm.errors.allowed_employee,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-4"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.out_site"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.createProgram.out_site.$model,expression:"$v.createProgram.out_site.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createProgram.out_site.$error||_vm.errors.out_site,"is-valid":!_vm.$v.createProgram.out_site.$invalid&&!_vm.errors.out_site},attrs:{type:"number"},domProps:{value:_vm.$v.createProgram.out_site.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createProgram.out_site,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.out_site?_vm._l(_vm.errors.out_site,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-4"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.startDate"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("date-picker",{attrs:{type:"datetime","default-value":_vm.createProgram.custom_date_start,confirm:""},on:{change:_vm.start_date},model:{value:_vm.createProgram.custom_date_start,callback:function callback($$v){_vm.$set(_vm.createProgram,"custom_date_start",$$v);},expression:"createProgram.custom_date_start"}}),_vm._v(" "),!_vm.$v.createProgram.start_date.required?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.fieldIsRequired"))+"\n                                    ")]):_vm._e(),_vm._v(" "),_vm.errors.start_date?_vm._l(_vm.errors.start_date,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                        ")]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-4"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.endDate"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("date-picker",{attrs:{type:"datetime",confirm:""},on:{change:_vm.end_date},model:{value:_vm.createProgram.custom_date_end,callback:function callback($$v){_vm.$set(_vm.createProgram,"custom_date_end",$$v);},expression:"createProgram.custom_date_end"}}),_vm._v(" "),_vm.errors.end_date?_vm._l(_vm.errors.end_date,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                        ")]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-4"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"mr-2"},[_vm._v("\n                                        Is Web ?\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("b-form-group",{"class":{"is-invalid":_vm.$v.createProgram.is_web.$error||_vm.errors.is_web,"is-valid":!_vm.$v.createProgram.is_web.$invalid&&!_vm.errors.is_web}},[_c("b-form-radio",{staticClass:"d-inline-block",attrs:{name:"some-radios",value:"1"},model:{value:_vm.$v.createProgram.is_web.$model,callback:function callback($$v){_vm.$set(_vm.$v.createProgram.is_web,"$model",$$v);},expression:"$v.createProgram.is_web.$model"}},[_vm._v(_vm._s(_vm.$t("general.Active"))+"\n                                        ")]),_vm._v(" "),_c("b-form-radio",{staticClass:"d-inline-block m-1",attrs:{name:"some-radios",value:"0"},model:{value:_vm.$v.createProgram.is_web.$model,callback:function callback($$v){_vm.$set(_vm.$v.createProgram.is_web,"$model",$$v);},expression:"$v.createProgram.is_web.$model"}},[_vm._v(_vm._s(_vm.$t("general.Inactive"))+"\n                                        ")])],1),_vm._v(" "),_vm.errors.is_web?_vm._l(_vm.errors.is_web,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                        ")]);}):_vm._e()],2)])])])],1)],1)]),_vm._v(" "),_c("div",{staticClass:"table-responsive mb-3 custom-table-theme position-relative"},[_vm.isLoader?_c("loader",{attrs:{size:"large"}}):_vm._e(),_vm._v(" "),_c("table",{ref:"exportable_table",staticClass:"table table-borderless table-centered m-0",attrs:{id:"printMe"}},[_c("thead",[_c("tr",[_vm.enabled3?_c("th",{staticClass:"do-not-print",staticStyle:{width:"0"},attrs:{scope:"col"}},[_c("div",{staticClass:"form-check custom-control"},[_c("input",{directives:[{name:"model",rawName:"v-model",value:_vm.isCheckAll,expression:"isCheckAll"}],staticClass:"form-check-input",staticStyle:{width:"17px",height:"17px"},attrs:{type:"checkbox"},domProps:{checked:Array.isArray(_vm.isCheckAll)?_vm._i(_vm.isCheckAll,null)>-1:_vm.isCheckAll},on:{change:function change($event){var $$a=_vm.isCheckAll,$$el=$event.target,$$c=$$el.checked?true:false;if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.isCheckAll=$$a.concat([$$v]));}else{$$i>-1&&(_vm.isCheckAll=$$a.slice(0,$$i).concat($$a.slice($$i+1)));}}else{_vm.isCheckAll=$$c;}}}})])]):_vm._e(),_vm._v(" "),_vm.setting.name?_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.Name")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.partners.sort(_vm.sortString("name"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.partners.sort(_vm.sortString("-name"));}}})])])]):_vm._e(),_vm._v(" "),_vm.setting.name_e?_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.Name_en")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.partners.sort(_vm.sortString("name_e"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.partners.sort(_vm.sortString("-name_e"));}}})])])]):_vm._e(),_vm._v(" "),_vm.setting.email?_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("login.Emailaddress")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.partners.sort(_vm.sortString("email"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.partners.sort(_vm.sortString("-email"));}}})])])]):_vm._e(),_vm._v(" "),_vm.setting.mobile_no?_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(" "+_vm._s(_vm.$t("general.mobile_no")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.partners.sort(_vm.sortNumber("mobile_no"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.partners.sort(_vm.sortNumber("-mobile_no"));}}})])])]):_vm._e(),_vm._v(" "),_vm.setting.is_active?_c("th",[_vm._v("\n                    "+_vm._s(_vm.$t("general.Status"))+"\n                  ")]):_vm._e(),_vm._v(" "),_vm.enabled3?_c("th",{staticClass:"do-not-print"},[_vm._v(_vm._s(_vm.$t("general.Action")))]):_vm._e(),_vm._v(" "),_vm.enabled3?_c("th",{staticClass:"do-not-print"},[_c("i",{staticClass:"fas fa-ellipsis-v"})]):_vm._e()])]),_vm._v(" "),_vm.partners.length>0?_c("tbody",_vm._l(_vm.partners,function(data,index){return _c("tr",{key:data.id,staticClass:"body-tr-custom",on:{"!click":function click($event){return _vm.checkRow(data.id);},dblclick:function dblclick($event){$event.preventDefault();return _vm.$bvModal.show("modal-edit-".concat(data.id));}}},[_vm.enabled3?_c("td",{staticClass:"do-not-print"},[_c("div",{staticClass:"form-check custom-control",staticStyle:{"min-height":"1.9em"}},[_c("input",{directives:[{name:"model",rawName:"v-model",value:_vm.checkAll,expression:"checkAll"}],staticClass:"form-check-input",staticStyle:{width:"17px",height:"17px"},attrs:{type:"checkbox"},domProps:{value:data.id,checked:Array.isArray(_vm.checkAll)?_vm._i(_vm.checkAll,data.id)>-1:_vm.checkAll},on:{change:function change($event){var $$a=_vm.checkAll,$$el=$event.target,$$c=$$el.checked?true:false;if(Array.isArray($$a)){var $$v=data.id,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.checkAll=$$a.concat([$$v]));}else{$$i>-1&&(_vm.checkAll=$$a.slice(0,$$i).concat($$a.slice($$i+1)));}}else{_vm.checkAll=$$c;}}}})])]):_vm._e(),_vm._v(" "),_vm.setting.name?_c("td",[_c("h5",{staticClass:"m-0 font-weight-normal"},[_vm._v(_vm._s(data.name))])]):_vm._e(),_vm._v(" "),_vm.setting.name_e?_c("td",[_vm._v(_vm._s(data.name_e))]):_vm._e(),_vm._v(" "),_vm.setting.email?_c("td",[_vm._v(_vm._s(data.email))]):_vm._e(),_vm._v(" "),_vm.setting.mobile_no?_c("td",[_vm._v(_vm._s(data.mobile_no))]):_vm._e(),_vm._v(" "),_vm.setting.is_active?_c("td",[_c("span",{"class":[data.is_active=="active"?"bg-soft-success text-success":"bg-soft-danger  text-danger","badge"]},[_vm._v("\n                      "+_vm._s(data.is_active=="active"?"".concat(_vm.$t("general.Active")):"".concat(_vm.$t("general.Inactive")))+"\n                    ")])]):_vm._e(),_vm._v(" "),_vm.enabled3?_c("td",{staticClass:"do-not-print"},[_c("div",{staticClass:"btn-group"},[_c("button",{staticClass:"btn btn-sm dropdown-toggle dropdown-coustom",attrs:{type:"button","data-toggle":"dropdown","aria-expanded":"false"}},[_vm._v("\n                        "+_vm._s(_vm.$t("general.commands"))+"\n                        "),_c("i",{staticClass:"fas fa-angle-down"})]),_vm._v(" "),_c("div",{staticClass:"dropdown-menu dropdown-menu-custom"},[_c("a",{staticClass:"dropdown-item",attrs:{href:"#"},on:{click:function click($event){return _vm.$bvModal.show("modal-edit-".concat(data.id));}}},[_c("div",{staticClass:"d-flex justify-content-between align-items-center text-black"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.edit")))]),_vm._v(" "),_c("i",{staticClass:"mdi mdi-square-edit-outline text-info"})])]),_vm._v(" "),_c("a",{staticClass:"dropdown-item text-black",attrs:{href:"#"},on:{click:function click($event){$event.preventDefault();return _vm.deletePartner(data.id);}}},[_c("div",{staticClass:"d-flex justify-content-between align-items-center text-black"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.delete")))]),_vm._v(" "),_c("i",{staticClass:"fas fa-times text-danger"})])])])]),_vm._v(" "),_c("b-modal",{ref:"edit-".concat(data.id),refInFor:true,attrs:{id:"modal-edit-".concat(data.id),title:_vm.$t("partner.editpartner"),"title-class":"font-18","body-class":"p-4","dialog-class":"modal-full-width","hide-footer":true},on:{show:function show($event){return _vm.resetModalEdit(data.id);},hidden:function hidden($event){return _vm.resetModalHiddenEdit(data.id);}}},[_c("form",[_c("div",{staticClass:"mb-3 d-flex justify-content-end"},[!_vm.isLoader?_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.editSubmit(data.id);}}},[_vm._v("\n                            "+_vm._s(_vm.$t("general.Add"))+"\n                          ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1),_vm._v(" "),_c("b-button",{attrs:{variant:"danger",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.$bvModal.hide("modal-edit-".concat(data.id));}}},[_vm._v("\n                            "+_vm._s(_vm.$t("general.Cancel"))+"\n                          ")])],1),_vm._v(" "),_c("b-tabs",{attrs:{"nav-class":"nav-tabs nav-bordered"}},[_c("b-tab",{attrs:{title:_vm.$t("general.DataEntry"),active:""}},[_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-6 direction",attrs:{dir:"rtl"}},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"edit-1"}},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.Name"))+"\n                                                  "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.edit.name.$model,expression:"$v.edit.name.$model",modifiers:{trim:true}}],staticClass:"form-control arabicInput","class":{"is-invalid":_vm.$v.edit.name.$error||_vm.errors.name,"is-valid":!_vm.$v.edit.name.$invalid&&!_vm.errors.name},attrs:{type:"text",id:"edit-1"},domProps:{value:_vm.$v.edit.name.$model},on:{keyup:function keyup($event){return _vm.arabicValue(_vm.edit.name);},input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.edit.name,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.edit.name.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                  "+_vm._s(_vm.$v.edit.name.$params.minLength.min)+"\n                                                  "+_vm._s(_vm.$t("general.letters"))+"\n                                              ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.name.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                  "+_vm._s(_vm.$v.edit.name.$params.maxLength.max)+"\n                                                  "+_vm._s(_vm.$t("general.letters"))+"\n                                              ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.name.alphaArabic?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.alphaArabic"))+"\n                                              ")]):_vm._e(),_vm._v(" "),_vm.errors.name?_vm._l(_vm.errors.name,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6 direction-ltr",attrs:{dir:"ltr"}},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"edit-2"}},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.Name_en"))+"\n                                                  "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.edit.name_e.$model,expression:"$v.edit.name_e.$model",modifiers:{trim:true}}],staticClass:"form-control englishInput","class":{"is-invalid":_vm.$v.edit.name_e.$error||_vm.errors.name_e,"is-valid":!_vm.$v.edit.name_e.$invalid&&!_vm.errors.name_e},attrs:{type:"text",id:"edit-2"},domProps:{value:_vm.$v.edit.name_e.$model},on:{keyup:function keyup($event){return _vm.englishValue(_vm.edit.name_e);},input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.edit.name_e,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.edit.name_e.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                  "+_vm._s(_vm.$v.edit.name_e.$params.minLength.min)+"\n                                                  "+_vm._s(_vm.$t("general.letters"))+"\n                                              ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.name_e.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                  "+_vm._s(_vm.$v.edit.name_e.$params.maxLength.max)+"\n                                                  "+_vm._s(_vm.$t("general.letters"))+"\n                                              ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.name_e.alphaEnglish?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.alphaEnglish"))+"\n                                              ")]):_vm._e(),_vm._v(" "),_vm.errors.name_e?_vm._l(_vm.errors.name_e,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"edit-3"}},[_vm._v("\n                                                  "+_vm._s(_vm.$t("login.Emailaddress"))+"\n                                                  "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.edit.email.$model,expression:"$v.edit.email.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.edit.email.$error||_vm.errors.email,"is-valid":!_vm.$v.edit.email.$invalid&&!_vm.errors.email},attrs:{type:"email",id:"edit-3"},domProps:{value:_vm.$v.edit.email.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.edit.email,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.edit.email.email?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.PleaseEnterValidEmail"))+"\n                                              ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.email.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                  "+_vm._s(_vm.$v.edit.email.$params.minLength.min)+"\n                                                  "+_vm._s(_vm.$t("general.letters"))+"\n                                              ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.email.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                  "+_vm._s(_vm.$v.edit.email.$params.maxLength.max)+"\n                                                  "+_vm._s(_vm.$t("general.letters"))+"\n                                              ")]):_vm._e(),_vm._v(" "),_vm.errors.email?_vm._l(_vm.errors.email,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.mobile_no"))+"\n                                                  "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("VuePhoneNumberInput",{attrs:{"default-country-code":"KW","valid-color":"#28a745","error-color":"#dc3545","preferred-countries":["FR","EG","DE"]},on:{update:_vm.updatePhoneEdit},model:{value:_vm.$v.edit.mobile_no.$model,callback:function callback($$v){_vm.$set(_vm.$v.edit.mobile_no,"$model",$$v);},expression:"$v.edit.mobile_no.$model"}}),_vm._v(" "),_vm.errors.mobile_no?_vm._l(_vm.errors.mobile_no,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"mr-2 mb-2"},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.Status"))+"\n                                                  "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("b-form-group",{"class":{"is-invalid":_vm.$v.edit.is_active.$error||_vm.errors.is_active,"is-valid":!_vm.$v.edit.is_active.$invalid&&!_vm.errors.is_active}},[_c("b-form-radio",{staticClass:"d-inline-block",attrs:{name:"some-radios",value:"active"},model:{value:_vm.$v.edit.is_active.$model,callback:function callback($$v){_vm.$set(_vm.$v.edit.is_active,"$model",$$v);},expression:"$v.edit.is_active.$model"}},[_vm._v(_vm._s(_vm.$t("general.Active")))]),_vm._v(" "),_c("b-form-radio",{staticClass:"d-inline-block m-1",attrs:{name:"some-radios",value:"inactive"},model:{value:_vm.$v.edit.is_active.$model,callback:function callback($$v){_vm.$set(_vm.$v.edit.is_active,"$model",$$v);},expression:"$v.edit.is_active.$model"}},[_vm._v(_vm._s(_vm.$t("general.Inactive")))])],1),_vm._v(" "),_vm.errors.is_active?_vm._l(_vm.errors.is_active,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                                  ")]);}):_vm._e()],2)])])]),_vm._v(" "),_c("b-tab",{attrs:{title:_vm.$t("company.company")},on:{click:_vm.getDataCompany}},[_c("div",{staticClass:"row justify-content-between align-items-center mb-2 px-1"},[_c("div",{staticClass:"col-md-3 d-flex align-items-center mb-1 mb-xl-0"},[_c("b-button",{directives:[{name:"b-modal",rawName:"v-b-modal.create_company",modifiers:{create_company:true}}],staticClass:"btn-sm mx-1 font-weight-bold",attrs:{variant:"primary"}},[_vm._v("\n                                              "+_vm._s(_vm.$t("general.Create"))+"\n                                              "),_c("i",{staticClass:"fas fa-plus"})])],1),_vm._v(" "),_c("div",{staticClass:"col-xs-10 col-md-9 col-lg-7 d-flex align-items-center justify-content-end"})]),_vm._v(" "),_c("div",{staticClass:"table-responsive mb-3 custom-table-theme position-relative"},[_vm.isLoader?_c("loader",{attrs:{size:"large"}}):_vm._e(),_vm._v(" "),_c("table",{staticClass:"table table-borderless table-hover table-centered m-0"},[_c("thead",[_c("tr",[_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.Name")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortString("name"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortString("-name"));}}})])])]),_vm._v(" "),_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.Name_en")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortString("name_e"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortString("-name_e"));}}})])])]),_vm._v(" "),_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("login.Emailaddress")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortString("email"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortString("-email"));}}})])])]),_vm._v(" "),_c("th",[_vm._v("\n                                                  "+_vm._s(_vm.$t("partner.partner"))+"\n                                              ")]),_vm._v(" "),_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.mobile_no")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("phone"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("-phone"));}}})])])]),_vm._v(" "),_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.Valueaddedregistrationnumber")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("vat_no"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("-vat_no"));}}})])])]),_vm._v(" "),_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.CommercialRecord")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("cr"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("-cr"));}}})])])]),_vm._v(" "),_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.taxnumber")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("tax_id"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("-tax_id"));}}})])])]),_vm._v(" "),_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(" "+_vm._s(_vm.$t("general.address")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortString("address"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortString("-address"));}}})])])]),_vm._v(" "),_c("th",[_vm._v(_vm._s(_vm.$t("general.website")))]),_vm._v(" "),_c("th",[_vm._v(_vm._s(_vm.$t("general.Status")))]),_vm._v(" "),_vm.enabled3?_c("th",{staticClass:"do-not-print"},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.Action"))+"\n                                              ")]):_vm._e()])]),_vm._v(" "),_vm.companies.length>0?_c("tbody",_vm._l(_vm.companies,function(comp,index){var _attrs;return _c("tr",{key:comp.id,staticClass:"body-tr-custom",on:{"!click":function click($event){return _vm.checkRow(data.id);}}},[_c("td",[_vm._v("\n                                                  "+_vm._s(comp.name)+"\n                                              ")]),_vm._v(" "),_c("td",[_vm._v("\n                                                  "+_vm._s(comp.name_e)+"\n                                              ")]),_vm._v(" "),_c("td",[_vm._v("\n                                                  "+_vm._s(comp.email)+"\n                                              ")]),_vm._v(" "),_c("td",[_vm._v("\n                                                  "+_vm._s(_vm.$i18n.locale=="ar"?comp.partner.name:comp.partner.name_e)+"\n                                              ")]),_vm._v(" "),_c("td",[_vm._v("\n                                                  "+_vm._s(comp.phone)+"\n                                              ")]),_vm._v(" "),_c("td",[_vm._v("\n                                                  "+_vm._s(comp.vat_no)+"\n                                              ")]),_vm._v(" "),_c("td",[_vm._v("\n                                                  "+_vm._s(data.cr)+"\n                                              ")]),_vm._v(" "),_c("td",[_vm._v("\n                                                  "+_vm._s(comp.tax_id)+"\n                                              ")]),_vm._v(" "),_c("td",[_vm._v("\n                                                  "+_vm._s(comp.address)+"\n                                              ")]),_vm._v(" "),_c("td",[_vm._v("\n                                                  "+_vm._s(comp.url)+"\n                                              ")]),_vm._v(" "),_c("td",[_c("span",{"class":[comp.is_active=="active"?"bg-soft-success text-success":"bg-soft-danger  text-danger","badge"]},[_vm._v("\n                                                      "+_vm._s(comp.is_active=="active"?"".concat(_vm.$t("general.Active")):"".concat(_vm.$t("general.Inactive")))+"\n                                                    ")])]),_vm._v(" "),_vm.enabled3?_c("td",{staticClass:"do-not-print"},[_c("div",{staticClass:"btn-group"},[_c("button",{staticClass:"btn btn-sm dropdown-toggle dropdown-coustom",attrs:{type:"button","data-toggle":"dropdown","aria-expanded":"false"}},[_vm._v("\n                                                          "+_vm._s(_vm.$t("general.commands"))+"\n                                                          "),_c("i",{staticClass:"fas fa-angle-down"})]),_vm._v(" "),_c("div",{staticClass:"dropdown-menu dropdown-menu-custom"},[_c("a",{staticClass:"dropdown-item",attrs:{href:"#"},on:{click:function click($event){return _vm.$bvModal.show("modal-edit-company-".concat(comp.id));}}},[_c("div",{staticClass:"d-flex justify-content-between align-items-center text-black"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.edit")))]),_vm._v(" "),_c("i",{staticClass:"mdi mdi-square-edit-outline text-info"})])]),_vm._v(" "),_c("a",{staticClass:"dropdown-item text-black",attrs:{href:"#"},on:{click:function click($event){$event.preventDefault();return _vm.deletecompany(comp.id);}}},[_c("div",{staticClass:"d-flex justify-content-between align-items-center text-black"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.delete")))]),_vm._v(" "),_c("i",{staticClass:"fas fa-times text-danger"})])])])]),_vm._v(" "),_c("b-modal",{attrs:{id:"modal-edit-company-".concat(comp.id),title:_vm.$t("company.editcompany"),"title-class":"font-18","dialog-class":"modal-full-width","body-class":"paddingUnset","hide-footer":true},on:{show:function show($event){return _vm.resetModalComEdit(comp.id);},hidden:function hidden($event){return _vm.resetModalHiddenComEdit(comp.id);}}},[_c("form",[_c("div",{staticClass:"card-body"},[_c("div",{staticClass:"mt-1 d-flex justify-content-end"},[!_vm.isLoader?_c("b-button",{staticClass:"mx-1 font-weight-bold px-3",attrs:{variant:"success",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.editSubmitCom(comp.id,index);}}},[_vm._v("\n                                                                      "+_vm._s(_vm.$t("general.Save"))+"\n                                                                  ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1),_vm._v(" "),_c("b-button",{staticClass:"font-weight-bold",attrs:{variant:"danger",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.$bvModal.hide("modal-edit-company-".concat(comp.id));}}},[_vm._v("\n                                                                      "+_vm._s(_vm.$t("general.Cancel"))+"\n                                                                  ")])],1)]),_vm._v(" "),_c("b-tabs",{attrs:{"nav-class":"nav-tabs nav-bordered"}},[_c("b-tab",{attrs:{title:_vm.$t("general.DataEntry"),active:""}},[_c("div",{staticClass:"row justify-content-between"},[_c("div",{staticClass:"col-7"},[_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-6 direction",attrs:{dir:"rtl"}},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"edit-1"}},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Name"))+"\n                                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.editCompany.name.$model,expression:"$v.editCompany.name.$model",modifiers:{trim:true}}],staticClass:"form-control arabicInput","class":{"is-invalid":_vm.$v.editCompany.name.$error||_vm.errors.name,"is-valid":!_vm.$v.editCompany.name.$invalid&&!_vm.errors.name},attrs:{type:"text",id:"edit-1"},domProps:{value:_vm.$v.editCompany.name.$model},on:{keyup:function keyup($event){return _vm.arabicValueCompany(_vm.editCompany.name);},input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.editCompany.name,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.editCompany.name.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                                                          "+_vm._s(_vm.$v.editCompany.name.$params.minLength.min)+"\n                                                                                          "+_vm._s(_vm.$t("general.letters"))+"\n                                                                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.editCompany.name.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                                                          "+_vm._s(_vm.$v.editCompany.name.$params.maxLength.max)+"\n                                                                                          "+_vm._s(_vm.$t("general.letters"))+"\n                                                                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.editCompany.name.alphaArabic?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.alphaArabic"))+"\n                                                                                      ")]):_vm._e(),_vm._v(" "),_vm.errors.name?_vm._l(_vm.errors.name,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6 direction-ltr",attrs:{dir:"ltr"}},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-2"}},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Name_en"))+"\n                                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.editCompany.name_e.$model,expression:"$v.editCompany.name_e.$model",modifiers:{trim:true}}],staticClass:"form-control englishInput","class":{"is-invalid":_vm.$v.editCompany.name_e.$error||_vm.errors.name_e,"is-valid":!_vm.$v.editCompany.name_e.$invalid&&!_vm.errors.name_e},attrs:{type:"text",id:"editCompany-2"},domProps:{value:_vm.$v.editCompany.name_e.$model},on:{keyup:function keyup($event){return _vm.englishValueCompany(_vm.editCompany.name_e);},input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.editCompany.name_e,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.editCompany.name_e.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                                                          "+_vm._s(_vm.$v.editCompany.name_e.$params.minLength.min)+"\n                                                                                          "+_vm._s(_vm.$t("general.letters"))+"\n                                                                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.editCompany.name_e.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                                                          "+_vm._s(_vm.$v.editCompany.name_e.$params.maxLength.max)+"\n                                                                                          "+_vm._s(_vm.$t("general.letters"))+"\n                                                                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.editCompany.name_e.alphaEnglish?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.alphaEnglish"))+"\n                                                                                      ")]):_vm._e(),_vm._v(" "),_vm.errors.name_e?_vm._l(_vm.errors.name_e,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"editCompany-3"}},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("login.Emailaddress"))+"\n                                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.editCompany.email.$model,expression:"$v.editCompany.email.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.editCompany.email.$error||_vm.errors.email,"is-valid":!_vm.$v.editCompany.email.$invalid&&!_vm.errors.email},attrs:{type:"email",id:"editCompany-3"},domProps:{value:_vm.$v.editCompany.email.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.editCompany.email,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.editCompany.email.email?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.PleaseEnterValidEmail"))+"\n                                                                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.editCompany.email.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                                                          "+_vm._s(_vm.$v.editCompany.email.$params.minLength.min)+"\n                                                                                          "+_vm._s(_vm.$t("general.letters"))+"\n                                                                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.editCompany.email.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                                                          "+_vm._s(_vm.$v.editCompany.email.$params.maxLength.max)+"\n                                                                                          "+_vm._s(_vm.$t("general.letters"))+"\n                                                                                      ")]):_vm._e(),_vm._v(" "),_vm.errors.email?_vm._l(_vm.errors.email,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-12"}},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.address"))+"\n                                                                                      ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.editCompany.address.$model,expression:"\n                                          $v.editCompany.address.$model\n                                        ",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.editCompany.address.$error||_vm.errors.address,"is-valid":!_vm.$v.editCompany.address.$invalid&&!_vm.errors.address},attrs:{type:"text",id:"editCompany-12"},domProps:{value:_vm.$v.editCompany.address.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.editCompany.address,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.editCompany.address.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                                                          "+_vm._s(_vm.$v.editCompany.address.$params.minLength.min)+"\n                                                                                          "+_vm._s(_vm.$t("general.letters"))+"\n                                                                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.editCompany.address.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                                                          "+_vm._s(_vm.$v.editCompany.address.$params.maxLength.max)+"\n                                                                                          "+_vm._s(_vm.$t("general.letters"))+"\n                                                                                      ")]):_vm._e(),_vm._v(" "),_vm.errors.address?_vm._l(_vm.errors.address,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.mobile_no"))+"\n                                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("VuePhoneNumberInput",{attrs:(_attrs={"default-country-code":_vm.editCompany.country_code,"valid-color":"#28a745"},_defineProperty(_attrs,"default-country-code","KW"),_defineProperty(_attrs,"error-color","#dc3545"),_defineProperty(_attrs,"preferred-countries",["FR","EG","DE"]),_attrs),on:{update:_vm.updatePhoneComEdit},model:{value:_vm.$v.editCompany.phone.$model,callback:function callback($$v){_vm.$set(_vm.$v.editCompany.phone,"$model",$$v);},expression:"$v.editCompany.phone.$model"}}),_vm._v(" "),_vm.errors.phone?_vm._l(_vm.errors.phone,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.contact_person"))+"\n                                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("VuePhoneNumberInput",{attrs:{"default-country-code":"KW","valid-color":"#28a745","error-color":"#dc3545","preferred-countries":["FR","EG","DE"]},on:{update:_vm.updateContactPersonComEdit},model:{value:_vm.$v.editCompany.contact_person.$model,callback:function callback($$v){_vm.$set(_vm.$v.editCompany.contact_person,"$model",$$v);},expression:"$v.editCompany.contact_person.$model"}}),_vm._v(" "),_vm.errors.contact_person?_vm._l(_vm.errors.contact_person,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"editCompany-11"}},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.website"))+"\n                                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.editCompany.website.$model,expression:"\n                                          $v.editCompany.website.$model\n                                        ",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.editCompany.website.$error||_vm.errors.website,"is-valid":!_vm.$v.editCompany.website.$invalid&&!_vm.errors.website},attrs:{type:"url",id:"editCompany-11"},domProps:{value:_vm.$v.editCompany.website.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.editCompany.website,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.editCompany.website.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                                                          "+_vm._s(_vm.$v.editCompany.website.$params.minLength.min)+"\n                                                                                          "+_vm._s(_vm.$t("general.letters"))+"\n                                                                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.editCompany.website.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                                                          "+_vm._s(_vm.$v.editCompany.website.$params.maxLength.max)+"\n                                                                                          "+_vm._s(_vm.$t("general.letters"))+"\n                                                                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.editCompany.website.url?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Itmustbeyourlink"))+"\n                                                                                      ")]):_vm._e(),_vm._v(" "),_vm.errors.website?_vm._l(_vm.errors.website,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)])])]),_vm._v(" "),_c("div",{staticClass:"col-4"},[_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-6",staticStyle:{height:"67.6px"}}),_vm._v(" "),_c("div",{staticClass:"col-md-6",staticStyle:{height:"67.6px"}}),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"editCompany-5"}},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.taxnumber"))+"\n                                                                                      ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.editCompany.tax_id.$model,expression:"$v.editCompany.tax_id.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.editCompany.tax_id.$error||_vm.errors.tax_id,"is-valid":!_vm.$v.editCompany.tax_id.$invalid&&!_vm.errors.tax_id},attrs:{type:"number",id:"editCompany-5"},domProps:{value:_vm.$v.editCompany.tax_id.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.editCompany.tax_id,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.tax_id?_vm._l(_vm.errors.tax_id,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-8"}},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.CommercialRecord"))+"\n                                                                                      ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.editCompany.cr.$model,expression:"$v.editCompany.cr.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.editCompany.cr.$error||_vm.errors.cr,"is-valid":!_vm.$v.editCompany.cr.$invalid&&!_vm.errors.cr},attrs:{type:"text",id:"editCompany-8"},domProps:{value:_vm.$v.editCompany.cr.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.editCompany.cr,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.cr?_vm._l(_vm.errors.cr,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",staticStyle:{"font-size":"10px"},attrs:{"for":"field-6"}},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Valueaddedregistrationnumber"))+"\n                                                                                      ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.editCompany.vat_no.$model,expression:"$v.editCompany.vat_no.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.editCompany.vat_no.$error||_vm.errors.vat_no,"is-valid":!_vm.$v.editCompany.vat_no.$invalid&&!_vm.errors.vat_no},attrs:{type:"number",id:"editCompany-6"},domProps:{value:_vm.$v.editCompany.vat_no.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.editCompany.vat_no,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.vat_no?_vm._l(_vm.errors.vat_no,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"mr-2"},[_vm._v("\n                                                                                          "+_vm._s(_vm.$t("general.Status"))+"\n                                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("b-form-group",{"class":{"is-invalid":_vm.$v.editCompany.is_active.$error||_vm.errors.is_active,"is-valid":!_vm.$v.editCompany.is_active.$invalid&&!_vm.errors.is_active}},[_c("b-form-radio",{staticClass:"d-inline-block",attrs:{name:"some-radios-com1",value:"active"},model:{value:_vm.$v.editCompany.is_active.$model,callback:function callback($$v){_vm.$set(_vm.$v.editCompany.is_active,"$model",$$v);},expression:"$v.editCompany.is_active.$model"}},[_vm._v(_vm._s(_vm.$t("general.Active")))]),_vm._v(" "),_c("b-form-radio",{staticClass:"d-inline-block m-1",attrs:{name:"some-radios-com1",value:"inactive"},model:{value:_vm.$v.editCompany.is_active.$model,callback:function callback($$v){_vm.$set(_vm.$v.editCompany.is_active,"$model",$$v);},expression:"$v.editCompany.is_active.$model"}},[_vm._v(_vm._s(_vm.$t("general.Inactive")))])],1),_vm._v(" "),_vm.errors.is_active?_vm._l(_vm.errors.is_active,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                                                                          ")]);}):_vm._e()],2)])])])])]),_vm._v(" "),_c("b-tab",{attrs:{title:_vm.$t("company.LogoFileUpload")}},[_c("div",{staticClass:"row"},[_c("input",{staticClass:"input-file-upload position-absolute d-none",attrs:{accept:"image/png, image/gif, image/jpeg, image/jpg",type:"file",id:"uploadImageEdit"},on:{change:function change($event){$event.preventDefault();return _vm.onImageChanged.apply(null,arguments);}}}),_vm._v(" "),_c("div",{staticClass:"col-md-8 my-1"},[_c("div",{staticClass:"row align-content-between",staticStyle:{width:"100%",height:"100%"}},[_c("div",{staticClass:"col-12"},[_c("div",{staticClass:"d-flex flex-wrap"},_vm._l(_vm.images,function(photo,index){return _c("div",{key:photo.id,"class":["dropzone-previews col-4 position-relative mb-2"]},[_c("div",{"class":["card mb-0 shadow-none border",_vm.images.length-1==index?"bg-primary":""]},[_c("div",{staticClass:"p-2"},[_c("div",{staticClass:"row align-items-center"},[_c("div",{staticClass:"col-auto",on:{click:function click($event){_vm.showPhoto=photo.webp;}}},[_c("img",{staticClass:"avatar-sm rounded bg-light",attrs:{"data-dz-thumbnail":"",src:photo.webp},on:{error:function error($event){_vm.src="./images/img-1.png";}}})]),_vm._v(" "),_c("div",{staticClass:"col pl-0"},[_c("a",{"class":["font-weight-bold",_vm.images.length-1==index?"text-white":"text-muted"],attrs:{href:"javascript:void(0);","data-dz-name":""}},[_vm._v("\n                                                                                                              "+_vm._s(photo.name)+"\n                                                                                                          ")])]),_vm._v(" "),_c("a",{"class":["btn-danger dropzone-close",_vm.$i18n.locale=="ar"?"dropzone-close-rtl":""],attrs:{href:"javascript:void(0);","data-dz-remove":""},on:{click:function click($event){$event.preventDefault();return _vm.deleteImageCreate(photo.id,index);}}},[_c("i",{staticClass:"fe-x"})])])])])]);}),0)]),_vm._v(" "),_c("div",{staticClass:"footer-image col-12"},[!_vm.isLoader?_c("b-button",{staticClass:"mx-1 font-weight-bold px-3",attrs:{variant:"success",type:"button"},on:{click:_vm.changePhotoEdit}},[_vm._v("\n                                                                                      "+_vm._s(_vm.$t("general.Add"))+"\n                                                                                  ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1)],1)])]),_vm._v(" "),_c("div",{staticClass:"col-md-4"},[_c("div",{staticClass:"show-dropzone"},[_c("img",{staticClass:"img-thumbnail",attrs:{src:_vm.showPhoto},on:{error:function error($event){_vm.src="./images/img-1.png";}}})])])])])],1)],1)])],1):_vm._e()]);}),0):_c("tbody",[_c("tr",[_c("th",{staticClass:"text-center",attrs:{colspan:"15"}},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.notDataFound"))+"\n                                              ")])])])])],1)]),_vm._v(" "),_c("b-tab",{attrs:{title:_vm.$t("general.program"),disabled:!(_vm.companies.length>0)},on:{click:_vm.getDataProgram}},[_c("div",{staticClass:"row justify-content-between align-items-center mb-2 px-1"},[_c("div",{staticClass:"col-md-3 d-flex align-items-center mb-1 mb-xl-0"},[_c("b-button",{directives:[{name:"b-modal",rawName:"v-b-modal.create_module",modifiers:{create_module:true}}],staticClass:"btn-sm mx-1 font-weight-bold",attrs:{variant:"primary"}},[_vm._v("\n                                              "+_vm._s(_vm.$t("general.Create"))+"\n                                              "),_c("i",{staticClass:"fas fa-plus"})])],1),_vm._v(" "),_c("div",{staticClass:"col-xs-10 col-md-9 col-lg-7 d-flex align-items-center justify-content-end"})]),_vm._v(" "),_c("div",{staticClass:"table-responsive mb-3 custom-table-theme position-relative"},[_vm.isLoader?_c("loader",{attrs:{size:"large"}}):_vm._e(),_vm._v(" "),_c("table",{staticClass:"table table-borderless table-centered m-0"},[_c("thead",[_c("tr",[_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("company.company")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companyModules.sort(_vm.sortString("company_id"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companyModules.sort(_vm.sortString("-company_id"));}}})])])]),_vm._v(" "),_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("module.module")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companyModules.sort(_vm.sortString("module_id"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companyModules.sort(_vm.sortString("-module_id"));}}})])])]),_vm._v(" "),_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.allowed_users_no")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companyModules.sort(_vm.sortString("allowed_users_no"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companyModules.sort(_vm.sortString("-allowed_users_no"));}}})])])]),_vm._v(" "),_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.allowed_employee")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companyModules.sort(_vm.sortString("allowed_users_no"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companyModules.sort(_vm.sortString("-allowed_users_no"));}}})])])]),_vm._v(" "),_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.out_site")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companyModules.sort(_vm.sortString("allowed_users_no"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companyModules.sort(_vm.sortString("-allowed_users_no"));}}})])])]),_vm._v(" "),_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.startDate")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companyModules.sort(_vm.SortDate("start_date"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companyModules.sort(_vm.SortDate("-start_date"));}}})])])]),_vm._v(" "),_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.endDate")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companyModules.sortString(_vm.SortDate("end_date"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companyModules.sortString(_vm.SortDate("-end_date"));}}})])])]),_vm._v(" "),_vm.enabled3?_c("th",{staticClass:"do-not-print"},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.Action"))+"\n                                              ")]):_vm._e()])]),_vm._v(" "),_vm.companyModules.length>0?_c("tbody",_vm._l(_vm.companyModules,function(mod,index){return _c("tr",{key:mod.id,staticClass:"body-tr-custom"},[_c("td",[mod.company?[_vm._v("\n                                                      "+_vm._s(_vm.$i18n.locale=="ar"?mod.company.name:mod.company.name_e)+"\n                                                  ")]:_vm._e()],2),_vm._v(" "),_c("td",[mod.project_program_module?[_vm._v("\n                                                      "+_vm._s(_vm.$i18n.locale=="ar"?mod.project_program_module.name:mod.project_program_module.name_e)+"\n                                                  ")]:_vm._e()],2),_vm._v(" "),_c("td",[_vm._v("\n                                                  "+_vm._s(mod.allowed_users_no)+"\n                                              ")]),_vm._v(" "),_c("td",[_vm._v("\n                                                  "+_vm._s(mod.allowed_employee)+"\n                                              ")]),_vm._v(" "),_c("td",[_vm._v("\n                                                  "+_vm._s(mod.out_site)+"\n                                              ")]),_vm._v(" "),_c("td",[_vm._v("\n                                                  "+_vm._s(_vm.formatDate(mod.start_date))+"\n                                              ")]),_vm._v(" "),_c("td",[_vm._v("\n                                                  "+_vm._s(mod.end_date?_vm.formatDate(mod.end_date):null)+"\n                                              ")]),_vm._v(" "),_vm.enabled3?_c("td",{staticClass:"do-not-print"},[_c("div",{staticClass:"btn-group"},[_c("button",{staticClass:"btn btn-sm dropdown-toggle dropdown-coustom",attrs:{type:"button","data-toggle":"dropdown","aria-expanded":"false"}},[_vm._v("\n                                                          "+_vm._s(_vm.$t("general.commands"))+"\n                                                          "),_c("i",{staticClass:"fas fa-angle-down"})]),_vm._v(" "),_c("div",{staticClass:"dropdown-menu dropdown-menu-custom"},[_c("a",{staticClass:"dropdown-item",attrs:{href:"#"},on:{click:function click($event){return _vm.$bvModal.show("modal-edit-program-".concat(mod.id));}}},[_c("div",{staticClass:"d-flex justify-content-between align-items-center text-black"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.edit")))]),_vm._v(" "),_c("i",{staticClass:"mdi mdi-square-edit-outline text-info"})])]),_vm._v(" "),_c("a",{staticClass:"dropdown-item text-black",attrs:{href:"#"},on:{click:function click($event){$event.preventDefault();return _vm.deleteCompanyModule(mod.id);}}},[_c("div",{staticClass:"d-flex justify-content-between align-items-center text-black"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.delete")))]),_vm._v(" "),_c("i",{staticClass:"fas fa-times text-danger"})])])])]),_vm._v(" "),_c("b-modal",{ref:"edit-".concat(mod.id),refInFor:true,attrs:{id:"modal-edit-program-".concat(mod.id),title:_vm.$t("menuitems.Workflow.text"),"title-class":"font-18","body-class":"p-4","hide-footer":true},on:{show:function show($event){return _vm.resetModalProgramEdit(mod.id);},hidden:function hidden($event){return _vm.resetModalHiddenProgramEdit(mod.id);}}},[_c("form",[_c("div",{staticClass:"mb-3 d-flex justify-content-end"},[!_vm.isLoader?_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.editSubmitProgram(mod.id);}}},[_vm._v("\n                                                                  "+_vm._s(_vm.$t("general.Add"))+"\n                                                              ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1),_vm._v(" "),_c("b-button",{attrs:{variant:"danger",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.$bvModal.hide("modal-edit-program-".concat(mod.id));}}},[_vm._v("\n                                                                  "+_vm._s(_vm.$t("general.Cancel"))+"\n                                                              ")])],1),_vm._v(" "),_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                                          "+_vm._s(_vm.$t("company.company"))+"\n                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("multiselect",{attrs:{options:_vm.companies.map(function(type){return type.id;}),"custom-label":function customLabel(opt){return _vm.$i18n.locale=="ar"?_vm.companies.find(function(x){return x.id==opt;}).name:_vm.companies.find(function(x){return x.id==opt;}).name_e;}},model:{value:_vm.$v.editProgram.company_id.$model,callback:function callback($$v){_vm.$set(_vm.$v.editProgram.company_id,"$model",$$v);},expression:"$v.editProgram.company_id.$model"}}),_vm._v(" "),!_vm.$v.editProgram.company_id.required?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                          "+_vm._s(_vm.$t("general.fieldIsRequired"))+"\n                                                                      ")]):_vm._e(),_vm._v(" "),_vm.errors.company_id?_vm._l(_vm.errors.name,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                                          "+_vm._s(_vm.$t("module.module"))+"\n                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("multiselect",{attrs:{options:_vm.modules.map(function(type){return type.id;}),"custom-label":function customLabel(opt){return _vm.modules.find(function(x){return x.id==opt;})?_vm.$i18n.locale=="ar"?"".concat(_vm.modules.find(function(x){return x.id==opt;}).parent.name,"|").concat(_vm.modules.find(function(x){return x.id==opt;}).name):"".concat(_vm.modules.find(function(x){return x.id==opt;}).parent.name_e,"|").concat(_vm.modules.find(function(x){return x.id==opt;}).name_e):null;}},model:{value:_vm.$v.editProgram.module_id.$model,callback:function callback($$v){_vm.$set(_vm.$v.editProgram.module_id,"$model",$$v);},expression:"$v.editProgram.module_id.$model"}}),_vm._v(" "),!_vm.$v.editProgram.module_id.required?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                          "+_vm._s(_vm.$t("general.fieldIsRequired"))+"\n                                                                      ")]):_vm._e(),_vm._v(" "),_vm.errors.module_id?_vm._l(_vm.errors.name,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                                          "+_vm._s(_vm.$t("general.document_types"))+"\n                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("multiselect",{attrs:{multiple:true,options:_vm.document_types.map(function(type){return type.id;}),"custom-label":function customLabel(opt){return _vm.document_types.find(function(x){return x.id==opt;})?_vm.$i18n.locale=="ar"?_vm.document_types.find(function(x){return x.id==opt;}).name:_vm.document_types.find(function(x){return x.id==opt;}).name_e:null;}},model:{value:_vm.$v.editProgram.document_types.$model,callback:function callback($$v){_vm.$set(_vm.$v.editProgram.document_types,"$model",$$v);},expression:"$v.editProgram.document_types.$model"}}),_vm._v(" "),_vm.errors.document_types?_vm._l(_vm.errors.document_types,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                                          "+_vm._s(_vm.$t("general.allowed_users_no"))+"\n                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.editProgram.allowed_users_no.$model,expression:"$v.editProgram.allowed_users_no.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.editProgram.allowed_users_no.$error||_vm.errors.allowed_users_no,"is-valid":!_vm.$v.editProgram.allowed_users_no.$invalid&&!_vm.errors.allowed_users_no},attrs:{type:"number"},domProps:{value:_vm.$v.editProgram.allowed_users_no.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.editProgram.allowed_users_no,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.allowed_users_no?_vm._l(_vm.errors.allowed_users_no,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                                          "+_vm._s(_vm.$t("general.allowed_employee"))+"\n                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.editProgram.allowed_employee.$model,expression:"$v.editProgram.allowed_employee.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.editProgram.allowed_employee.$error||_vm.errors.allowed_employee,"is-valid":!_vm.$v.editProgram.allowed_employee.$invalid&&!_vm.errors.allowed_employee},attrs:{type:"number"},domProps:{value:_vm.$v.editProgram.allowed_employee.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.editProgram.allowed_employee,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.allowed_employee?_vm._l(_vm.errors.allowed_employee,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                                          "+_vm._s(_vm.$t("general.out_site"))+"\n                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.editProgram.out_site.$model,expression:"$v.editProgram.out_site.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.editProgram.out_site.$error||_vm.errors.out_site,"is-valid":!_vm.$v.editProgram.out_site.$invalid&&!_vm.errors.out_site},attrs:{type:"number"},domProps:{value:_vm.$v.editProgram.out_site.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.editProgram.out_site,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.out_site?_vm._l(_vm.errors.out_site,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                                          "+_vm._s(_vm.$t("general.startDate"))+"\n                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("date-picker",{attrs:{type:"datetime","default-value":_vm.editProgram.custom_date_start,confirm:""},on:{change:_vm.start_date},model:{value:_vm.editProgram.custom_date_start,callback:function callback($$v){_vm.$set(_vm.editProgram,"custom_date_start",$$v);},expression:"editProgram.custom_date_start"}}),_vm._v(" "),!_vm.$v.editProgram.start_date.required?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                                          "+_vm._s(_vm.$t("general.fieldIsRequired"))+"\n                                                                      ")]):_vm._e(),_vm._v(" "),_vm.errors.start_date?_vm._l(_vm.errors.start_date,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                                          "+_vm._s(_vm.$t("general.endDate"))+"\n                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("date-picker",{attrs:{type:"datetime",confirm:""},on:{change:_vm.end_date},model:{value:_vm.editProgram.custom_date_end,callback:function callback($$v){_vm.$set(_vm.editProgram,"custom_date_end",$$v);},expression:"editProgram.custom_date_end"}}),_vm._v(" "),_vm.errors.end_date?_vm._l(_vm.errors.end_date,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"mr-2"},[_vm._v("\n                                                                          Is Web ?\n                                                                          "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("b-form-group",{"class":{"is-invalid":_vm.$v.editProgram.is_web.$error||_vm.errors.is_web,"is-valid":!_vm.$v.editProgram.is_web.$invalid&&!_vm.errors.is_web}},[_c("b-form-radio",{staticClass:"d-inline-block",attrs:{name:"some-radios-editpro",value:"1"},model:{value:_vm.$v.editProgram.is_web.$model,callback:function callback($$v){_vm.$set(_vm.$v.editProgram.is_web,"$model",$$v);},expression:"$v.editProgram.is_web.$model"}},[_vm._v(_vm._s(_vm.$t("general.Active"))+"\n                                                                          ")]),_vm._v(" "),_c("b-form-radio",{staticClass:"d-inline-block m-1",attrs:{name:"some-radios-editpro",value:"0"},model:{value:_vm.$v.editProgram.is_web.$model,callback:function callback($$v){_vm.$set(_vm.$v.editProgram.is_web,"$model",$$v);},expression:"$v.editProgram.is_web.$model"}},[_vm._v(_vm._s(_vm.$t("general.Inactive"))+"\n                                                                          ")])],1),_vm._v(" "),_vm.errors.is_web?_vm._l(_vm.errors.is_web,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                                                          ")]);}):_vm._e()],2)])])])])],1):_vm._e()]);}),0):_c("tbody",[_c("tr",[_c("th",{staticClass:"text-center",attrs:{colspan:"7"}},[_vm._v("\n                                                  "+_vm._s(_vm.$t("general.notDataFound"))+"\n                                              ")])])])])],1)])],1)],1)])],1):_vm._e(),_vm._v(" "),_vm.enabled3?_c("td",{staticClass:"do-not-print"},[_c("b-button",{staticClass:"btn",attrs:{id:"tooltip-button-"+data.id,variant:_vm.$i18n.locale=="en"?"left":"right"},on:{mouseover:function mouseover($event){return _vm.log(data.id);},mousemove:function mousemove($event){return _vm.log(data.id);}}},[_c("i",{staticClass:"fe-info",staticStyle:{"font-size":"22px"}})]),_vm._v(" "),_c("b-tooltip",{attrs:{target:"tooltip-button-"+data.id,placement:_vm.$i18n.locale=="en"?"left":"right"}},[_vm._v(_vm._s(_vm.Tooltip))])],1):_vm._e()]);}),0):_c("tbody",[_c("tr",[_c("th",{staticClass:"text-center",attrs:{colspan:"7"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.notDataFound"))+"\n                  ")])])])])],1),_vm._v(" "),_c("b-modal",{attrs:{id:"create_company",title:_vm.$t("company.addcompany"),"title-class":"font-18","dialog-class":"modal-full-width","body-class":"paddingUnset","hide-footer":true},on:{show:_vm.resetFormCom,hidden:_vm.resetFormCom}},[_c("form",[_c("div",{staticClass:"card"},[_c("div",{staticClass:"card-body"},[_c("div",{staticClass:"mt-1 d-flex justify-content-end"},[_c("b-button",{"class":["font-weight-bold px-2",_vm.is_disabledCom?"mx-2":""],attrs:{variant:"success",disabled:!_vm.is_disabledCom,type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.resetFormCom.apply(null,arguments);}}},[_vm._v("\n                                    "+_vm._s(_vm.$t("general.AddNewRecord"))+"\n                                ")]),_vm._v(" "),!_vm.is_disabledCom?[!_vm.isLoader?_c("b-button",{staticClass:"mx-1 font-weight-bold px-3",attrs:{variant:"success",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.AddSubmitCom("edit");}}},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Save"))+"\n                                    ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1)]:_vm._e(),_vm._v(" "),_c("b-button",{staticClass:"font-weight-bold",attrs:{variant:"danger",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.$bvModal.hide("create_company");}}},[_vm._v("\n                                    "+_vm._s(_vm.$t("general.Cancel"))+"\n                                ")])],2)]),_vm._v(" "),_c("b-tabs",{attrs:{"nav-class":"nav-tabs nav-bordered"}},[_c("b-tab",{attrs:{title:_vm.$t("general.DataEntry"),active:""}},[_c("div",{staticClass:"row justify-content-between"},[_c("div",{staticClass:"col-7"},[_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-6 direction",attrs:{dir:"rtl"}},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-1"}},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Name"))+"\n                                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.createCompany.name.$model,expression:"$v.createCompany.name.$model",modifiers:{trim:true}}],staticClass:"form-control arabicInput","class":{"is-invalid":_vm.$v.createCompany.name.$error||_vm.errors.name,"is-valid":!_vm.$v.createCompany.name.$invalid&&!_vm.errors.name},attrs:{type:"text"},domProps:{value:_vm.$v.createCompany.name.$model},on:{keyup:function keyup($event){return _vm.arabicValueCompany(_vm.createCompany.name);},input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.name,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.createCompany.name.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                        "+_vm._s(_vm.$v.createCompany.name.$params.minLength.min)+"\n                                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.createCompany.name.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                        "+_vm._s(_vm.$v.createCompany.name.$params.maxLength.max)+"\n                                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                                    ")]):_vm._e(),_vm._v(" "),_vm.errors.name?_vm._l(_vm.errors.name,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6 direction-ltr",attrs:{dir:"ltr"}},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-2"}},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Name_en"))+"\n                                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.createCompany.name_e.$model,expression:"$v.createCompany.name_e.$model",modifiers:{trim:true}}],staticClass:"form-control englishInput","class":{"is-invalid":_vm.$v.createCompany.name_e.$error||_vm.errors.name_e,"is-valid":!_vm.$v.createCompany.name_e.$invalid&&!_vm.errors.name_e},attrs:{type:"text",id:"field-2"},domProps:{value:_vm.$v.createCompany.name_e.$model},on:{keyup:function keyup($event){return _vm.englishValueCompany(_vm.createCompany.name_e);},input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.name_e,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.createCompany.name_e.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                        "+_vm._s(_vm.$v.createCompany.name_e.$params.minLength.min)+"\n                                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.createCompany.name_e.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                        "+_vm._s(_vm.$v.createCompany.name_e.$params.maxLength.max)+"\n                                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                                    ")]):_vm._e(),_vm._v(" "),_vm.errors.name_e?_vm._l(_vm.errors.name_e,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-3"}},[_vm._v("\n                                                        "+_vm._s(_vm.$t("login.Emailaddress"))+"\n                                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.createCompany.email.$model,expression:"$v.createCompany.email.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createCompany.email.$error||_vm.errors.email,"is-valid":!_vm.$v.createCompany.email.$invalid&&!_vm.errors.email},attrs:{type:"email",id:"field-3"},domProps:{value:_vm.$v.createCompany.email.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.email,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.createCompany.email.email?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.PleaseEnterValidEmail"))+"\n                                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.createCompany.email.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                        "+_vm._s(_vm.$v.createCompany.email.$params.minLength.min)+"\n                                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.createCompany.email.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                        "+_vm._s(_vm.$v.createCompany.email.$params.maxLength.max)+"\n                                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                                    ")]):_vm._e(),_vm._v(" "),_vm.errors.email?_vm._l(_vm.errors.email,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-12"}},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.address"))+"\n                                                    ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.createCompany.address.$model,expression:"$v.createCompany.address.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createCompany.address.$error||_vm.errors.address,"is-valid":!_vm.$v.createCompany.address.$invalid&&!_vm.errors.address},attrs:{type:"text",id:"field-12"},domProps:{value:_vm.$v.createCompany.address.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.address,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.createCompany.address.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                        "+_vm._s(_vm.$v.createCompany.address.$params.minLength.min)+"\n                                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.createCompany.address.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                        "+_vm._s(_vm.$v.createCompany.address.$params.maxLength.max)+"\n                                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                                    ")]):_vm._e(),_vm._v(" "),_vm.errors.address?_vm._l(_vm.errors.address,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.mobile_no"))+"\n                                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("VuePhoneNumberInput",{attrs:{"default-country-code":"KW","valid-color":"#28a745","error-color":"#dc3545","preferred-countries":["FR","EG","DE"]},on:{update:_vm.updatePhoneCom},model:{value:_vm.$v.createCompany.phone.$model,callback:function callback($$v){_vm.$set(_vm.$v.createCompany.phone,"$model",$$v);},expression:"$v.createCompany.phone.$model"}}),_vm._v(" "),_vm.errors.phone?_vm._l(_vm.errors.phone,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.contact_person"))+"\n                                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("VuePhoneNumberInput",{attrs:{"default-country-code":"KW","valid-color":"#28a745","error-color":"#dc3545","preferred-countries":["FR","EG","DE"]},on:{update:_vm.updateContactPersonCom},model:{value:_vm.$v.createCompany.contact_person.$model,callback:function callback($$v){_vm.$set(_vm.$v.createCompany.contact_person,"$model",$$v);},expression:"$v.createCompany.contact_person.$model"}}),_vm._v(" "),_vm.errors.contact_person?_vm._l(_vm.errors.contact_person,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-11"}},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.website"))+"\n                                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.createCompany.website.$model,expression:"$v.createCompany.website.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createCompany.website.$error||_vm.errors.website,"is-valid":!_vm.$v.createCompany.website.$invalid&&!_vm.errors.website},attrs:{type:"url",id:"field-11"},domProps:{value:_vm.$v.createCompany.website.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.website,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.createCompany.website.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                        "+_vm._s(_vm.$v.createCompany.website.$params.minLength.min)+"\n                                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.createCompany.website.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                        "+_vm._s(_vm.$v.createCompany.website.$params.maxLength.max)+"\n                                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.createCompany.website.url?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Itmustbeyourlink"))+"\n                                                    ")]):_vm._e(),_vm._v(" "),_vm.errors.website?_vm._l(_vm.errors.website,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)])])]),_vm._v(" "),_c("div",{staticClass:"col-4"},[_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-6",staticStyle:{height:"67.6px"}}),_vm._v(" "),_c("div",{staticClass:"col-md-6",staticStyle:{height:"67.6px"}}),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-5"}},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.taxnumber"))+"\n                                                    ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.createCompany.tax_id.$model,expression:"$v.createCompany.tax_id.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createCompany.tax_id.$error||_vm.errors.tax_id,"is-valid":!_vm.$v.createCompany.tax_id.$invalid&&!_vm.errors.tax_id},attrs:{min:"0",type:"number",id:"field-5"},domProps:{value:_vm.$v.createCompany.tax_id.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.tax_id,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.tax_id?_vm._l(_vm.errors.tax_id,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-8"}},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.CommercialRecord"))+"\n                                                    ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.createCompany.cr.$model,expression:"$v.createCompany.cr.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createCompany.cr.$error||_vm.errors.cr,"is-valid":!_vm.$v.createCompany.cr.$invalid&&!_vm.errors.cr},attrs:{type:"text",id:"field-8"},domProps:{value:_vm.$v.createCompany.cr.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.cr,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.cr?_vm._l(_vm.errors.cr,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",staticStyle:{"font-size":"10px"},attrs:{"for":"field-6"}},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Valueaddedregistrationnumber"))+"\n                                                    ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.createCompany.vat_no.$model,expression:"$v.createCompany.vat_no.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createCompany.vat_no.$error||_vm.errors.vat_no,"is-valid":!_vm.$v.createCompany.vat_no.$invalid&&!_vm.errors.vat_no},attrs:{type:"number",id:"field-6"},domProps:{value:_vm.$v.createCompany.vat_no.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createCompany.vat_no,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.vat_no?_vm._l(_vm.errors.vat_no,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"mr-2"},[_vm._v("\n                                                        "+_vm._s(_vm.$t("general.Status"))+"\n                                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("b-form-group",{"class":{"is-invalid":_vm.$v.createCompany.is_active.$error||_vm.errors.is_active,"is-valid":!_vm.$v.createCompany.is_active.$invalid&&!_vm.errors.is_active}},[_c("b-form-radio",{staticClass:"d-inline-block",attrs:{name:"some-radio-pp",value:"active"},model:{value:_vm.$v.createCompany.is_active.$model,callback:function callback($$v){_vm.$set(_vm.$v.createCompany.is_active,"$model",$$v);},expression:"$v.createCompany.is_active.$model"}},[_vm._v(_vm._s(_vm.$t("general.Active")))]),_vm._v(" "),_c("b-form-radio",{staticClass:"d-inline-block m-1",attrs:{name:"some-radio-pp",value:"inactive"},model:{value:_vm.$v.createCompany.is_active.$model,callback:function callback($$v){_vm.$set(_vm.$v.createCompany.is_active,"$model",$$v);},expression:"$v.createCompany.is_active.$model"}},[_vm._v(_vm._s(_vm.$t("general.Inactive")))])],1),_vm._v(" "),_vm.errors.is_active?_vm._l(_vm.errors.is_active,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                                        ")]);}):_vm._e()],2)])])])])]),_vm._v(" "),_c("b-tab",{attrs:{disabled:!_vm.company_id,title:_vm.$t("company.LogoFileUpload")}},[_c("div",{staticClass:"row"},[_c("input",{staticClass:"input-file-upload position-absolute d-none",attrs:{accept:"image/png, image/gif, image/jpeg, image/jpg",type:"file",id:"uploadImageCreate"},on:{change:function change($event){$event.preventDefault();return _vm.onImageChanged.apply(null,arguments);}}}),_vm._v(" "),_c("div",{staticClass:"col-md-8 my-1"},[_c("div",{staticClass:"row align-content-between",staticStyle:{width:"100%",height:"100%"}},[_c("div",{staticClass:"col-12"},[_c("div",{staticClass:"d-flex flex-wrap"},_vm._l(_vm.images,function(photo,index){return _c("div",{key:photo.id,"class":["dropzone-previews col-4 position-relative mb-2"]},[_c("div",{"class":["card mb-0 shadow-none border",_vm.images.length-1==index?"bg-primary":""]},[_c("div",{staticClass:"p-2"},[_c("div",{staticClass:"row align-items-center"},[_c("div",{staticClass:"col-auto",on:{click:function click($event){_vm.showPhoto=photo.webp;}}},[_c("img",{staticClass:"avatar-sm rounded bg-light",attrs:{"data-dz-thumbnail":"",src:photo.webp},on:{error:function error($event){_vm.src="./images/img-1.png";}}})]),_vm._v(" "),_c("div",{staticClass:"col pl-0"},[_c("a",{"class":["font-weight-bold",_vm.images.length-1==index?"text-white":"text-muted"],attrs:{href:"javascript:void(0);","data-dz-name":""}},[_vm._v("\n                                                                            "+_vm._s(photo.name)+"\n                                                                        ")])]),_vm._v(" "),_c("a",{"class":["btn-danger dropzone-close",_vm.$i18n.locale=="ar"?"dropzone-close-rtl":""],attrs:{href:"javascript:void(0);","data-dz-remove":""},on:{click:function click($event){$event.preventDefault();return _vm.deleteImageCreate(photo.id,index);}}},[_c("i",{staticClass:"fe-x"})])])])])]);}),0)]),_vm._v(" "),_c("div",{staticClass:"footer-image col-12"},[!_vm.isLoader?_c("b-button",{staticClass:"mx-1 font-weight-bold px-3",attrs:{variant:"success",type:"button"},on:{click:_vm.changePhoto}},[_vm._v("\n                                                    "+_vm._s(_vm.$t("general.Add"))+"\n                                                ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1)],1)])]),_vm._v(" "),_c("div",{staticClass:"col-md-4"},[_c("div",{staticClass:"show-dropzone"},[_c("img",{staticClass:"img-thumbnail",attrs:{src:_vm.showPhoto},on:{error:function error($event){_vm.src="./images/img-1.png";}}})])])])])],1)],1)])]),_vm._v(" "),_c("b-modal",{attrs:{id:"create_module",title:_vm.$t("menuitems.Workflow.text"),"title-class":"font-18","body-class":"p-4","hide-footer":true},on:{show:function show($event){return _vm.resetFormProgram("edit");}}},[_c("form",[_c("div",{staticClass:"mb-3 d-flex justify-content-end"},[_c("b-button",{"class":["font-weight-bold px-2",!_vm.is_disabledCom?"":"mx-2"],attrs:{variant:"success",disabled:!_vm.is_disabledCom,type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.resetFormProgram.apply(null,arguments);}}},[_vm._v("\n                            "+_vm._s(_vm.$t("general.AddNewRecord"))+"\n                        ")]),_vm._v(" "),!_vm.is_disabledCom?[!_vm.isLoader?_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.AddSubmitProgram("edit");}}},[_vm._v("\n                                "+_vm._s(_vm.$t("general.Add"))+"\n                            ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1)]:_vm._e(),_vm._v(" "),_c("b-button",{attrs:{variant:"danger",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.$bvModal.hide("create_module");}}},[_vm._v("\n                            "+_vm._s(_vm.$t("general.Cancel"))+"\n                        ")])],2),_vm._v(" "),_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                    "+_vm._s(_vm.$t("company.company"))+"\n                                    "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("multiselect",{attrs:{options:_vm.companies.map(function(type){return type.id;}),"custom-label":function customLabel(opt){return _vm.$i18n.locale=="ar"?_vm.companies.find(function(x){return x.id==opt;}).name:_vm.companies.find(function(x){return x.id==opt;}).name_e;}},model:{value:_vm.$v.createProgram.company_id.$model,callback:function callback($$v){_vm.$set(_vm.$v.createProgram.company_id,"$model",$$v);},expression:"$v.createProgram.company_id.$model"}}),_vm._v(" "),!_vm.$v.createProgram.company_id.required?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                    "+_vm._s(_vm.$t("general.fieldIsRequired"))+"\n                                ")]):_vm._e(),_vm._v(" "),_vm.errors.company_id?_vm._l(_vm.errors.name,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                    ")]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                    "+_vm._s(_vm.$t("module.module"))+"\n                                    "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("multiselect",{attrs:{options:_vm.modules.map(function(type){return type.id;}),"custom-label":function customLabel(opt){return _vm.$i18n.locale=="ar"?"".concat(_vm.modules.find(function(x){return x.id==opt;}).parent.name,"|").concat(_vm.modules.find(function(x){return x.id==opt;}).name):"".concat(_vm.modules.find(function(x){return x.id==opt;}).parent.name_e,"|").concat(_vm.modules.find(function(x){return x.id==opt;}).name_e);}},model:{value:_vm.$v.createProgram.module_id.$model,callback:function callback($$v){_vm.$set(_vm.$v.createProgram.module_id,"$model",$$v);},expression:"$v.createProgram.module_id.$model"}}),_vm._v(" "),!_vm.$v.createProgram.module_id.required?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                    "+_vm._s(_vm.$t("general.fieldIsRequired"))+"\n                                ")]):_vm._e(),_vm._v(" "),_vm.errors.module_id?_vm._l(_vm.errors.name,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                    ")]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                    "+_vm._s(_vm.$t("general.document_types"))+"\n                                    "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("multiselect",{attrs:{multiple:true,options:_vm.document_types.map(function(type){return type.id;}),"custom-label":function customLabel(opt){return _vm.$i18n.locale=="ar"?_vm.document_types.find(function(x){return x.id==opt;}).name:_vm.document_types.find(function(x){return x.id==opt;}).name_e;}},model:{value:_vm.$v.createProgram.document_types.$model,callback:function callback($$v){_vm.$set(_vm.$v.createProgram.document_types,"$model",$$v);},expression:"$v.createProgram.document_types.$model"}}),_vm._v(" "),_vm.errors.document_types?_vm._l(_vm.errors.document_types,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                    "+_vm._s(_vm.$t("general.allowed_users_no"))+"\n                                    "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.createProgram.allowed_users_no.$model,expression:"$v.createProgram.allowed_users_no.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createProgram.allowed_users_no.$error||_vm.errors.allowed_users_no,"is-valid":!_vm.$v.createProgram.allowed_users_no.$invalid&&!_vm.errors.allowed_users_no},attrs:{type:"number"},domProps:{value:_vm.$v.createProgram.allowed_users_no.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createProgram.allowed_users_no,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.allowed_users_no?_vm._l(_vm.errors.allowed_users_no,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                    "+_vm._s(_vm.$t("general.allowed_employee"))+"\n                                    "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.createProgram.allowed_employee.$model,expression:"$v.createProgram.allowed_employee.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createProgram.allowed_employee.$error||_vm.errors.allowed_employee,"is-valid":!_vm.$v.createProgram.allowed_employee.$invalid&&!_vm.errors.allowed_employee},attrs:{type:"number"},domProps:{value:_vm.$v.createProgram.allowed_employee.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createProgram.allowed_employee,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.allowed_employee?_vm._l(_vm.errors.allowed_employee,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                    "+_vm._s(_vm.$t("general.out_site"))+"\n                                    "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.createProgram.out_site.$model,expression:"$v.createProgram.out_site.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.createProgram.out_site.$error||_vm.errors.out_site,"is-valid":!_vm.$v.createProgram.out_site.$invalid&&!_vm.errors.out_site},attrs:{type:"number"},domProps:{value:_vm.$v.createProgram.out_site.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.createProgram.out_site,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.out_site?_vm._l(_vm.errors.out_site,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                    "+_vm._s(_vm.$t("general.startDate"))+"\n                                    "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("date-picker",{attrs:{type:"datetime","default-value":_vm.createProgram.custom_date_start,confirm:""},on:{change:_vm.start_date},model:{value:_vm.createProgram.custom_date_start,callback:function callback($$v){_vm.$set(_vm.createProgram,"custom_date_start",$$v);},expression:"createProgram.custom_date_start"}}),_vm._v(" "),!_vm.$v.createProgram.start_date.required?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                    "+_vm._s(_vm.$t("general.fieldIsRequired"))+"\n                                ")]):_vm._e(),_vm._v(" "),_vm.errors.start_date?_vm._l(_vm.errors.start_date,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                    ")]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                    "+_vm._s(_vm.$t("general.endDate"))+"\n                                    "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("date-picker",{attrs:{type:"datetime",confirm:""},on:{change:_vm.end_date},model:{value:_vm.createProgram.custom_date_end,callback:function callback($$v){_vm.$set(_vm.createProgram,"custom_date_end",$$v);},expression:"createProgram.custom_date_end"}}),_vm._v(" "),_vm.errors.end_date?_vm._l(_vm.errors.end_date,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                    ")]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"mr-2"},[_vm._v("\n                                    Is Web ?\n                                    "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("b-form-group",{"class":{"is-invalid":_vm.$v.createProgram.is_web.$error||_vm.errors.is_web,"is-valid":!_vm.$v.createProgram.is_web.$invalid&&!_vm.errors.is_web}},[_c("b-form-radio",{staticClass:"d-inline-block",attrs:{name:"some-radios",value:"1"},model:{value:_vm.$v.createProgram.is_web.$model,callback:function callback($$v){_vm.$set(_vm.$v.createProgram.is_web,"$model",$$v);},expression:"$v.createProgram.is_web.$model"}},[_vm._v(_vm._s(_vm.$t("general.Active"))+"\n                                    ")]),_vm._v(" "),_c("b-form-radio",{staticClass:"d-inline-block m-1",attrs:{name:"some-radios",value:"0"},model:{value:_vm.$v.createProgram.is_web.$model,callback:function callback($$v){_vm.$set(_vm.$v.createProgram.is_web,"$model",$$v);},expression:"$v.createProgram.is_web.$model"}},[_vm._v(_vm._s(_vm.$t("general.Inactive"))+"\n                                    ")])],1),_vm._v(" "),_vm.errors.is_web?_vm._l(_vm.errors.is_web,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                    ")]);}):_vm._e()],2)])])])])],1)])])])],1);};var staticRenderFns=[];render._withStripped=true;
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/partner/index.vue?vue&type=style&index=0&id=58613ede&lang=css&":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/partner/index.vue?vue&type=style&index=0&id=58613ede&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_58613ede_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=58613ede&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/partner/index.vue?vue&type=style&index=0&id=58613ede&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_58613ede_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony import */ var _index_vue_vue_type_style_index_0_id_58613ede_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=58613ede&lang=css& */ "./resources/js/views/pages/partner/index.vue?vue&type=style&index=0&id=58613ede&lang=css&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
/***/ "./resources/js/views/pages/partner/index.vue?vue&type=style&index=0&id=58613ede&lang=css&":
/*!*************************************************************************************************!*\
  !*** ./resources/js/views/pages/partner/index.vue?vue&type=style&index=0&id=58613ede&lang=css& ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_58613ede_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=58613ede&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/partner/index.vue?vue&type=style&index=0&id=58613ede&lang=css&");
