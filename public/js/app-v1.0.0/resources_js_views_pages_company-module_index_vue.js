        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/modules/all-program-modules").then(function (res) {
