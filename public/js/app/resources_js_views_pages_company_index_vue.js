...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  validations: {
    create: {
      ...
      website: {
        required: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_10__.required,
        url: vuelidate_lib_validators__WEBPACK_IMPORTED_MODULE_10__.url,
  ...
  methods: {
    ...
    log: function log(id) {
      ...
      if (this.mouseEnter != id) {
        this.Tooltip = "";
        this.mouseEnter = id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/companies/logs/".concat(id)).then(function (res) {
          var l = res.data.data;
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/companies?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.companiesPagination.last_page && this.current_page != this.companiesPagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/companies?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
          var l = res.data;
          _this5.companies = l.data;
          _this5.companiesPagination = l.pagination;
      ...
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/companies/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this6.checkAll = [];
              _this6.getData();
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid && !this.isVaildPhone) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/companies", _objectSpread(_objectSpread({}, this.create), {}, {
    ...
    editSubmit: function editSubmit(id, index) {
      ...
      if (this.$v.edit.$invalid && !this.isVaildPhone) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].put("/companies/".concat(id), _objectSpread(_objectSpread({}, this.edit), {}, {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/partners").then(function (res) {
                var l = res.data;
                _this12.partners = l.data;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                  icon: "error",
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              company = _this13.companies.find(function (e) {
                return id == e.id;
              });
              _context3.next = 3;
              return _this13.getPartner();
            case 3:
              _this13.company_id = company.id;
              _this13.isVaildPhone = false;
              _this13.company_id = company.id;
              _this13.edit.name = company.name;
              _this13.edit.name_e = company.name_e;
              _this13.edit.is_active = company.is_active;
              _this13.edit.email = company.email;
              _this13.edit.address = company.address;
              _this13.edit.cr = company.cr;
              _this13.edit.partner_id = company.partner.id;
              _this13.edit.tax_id = company.tax_id;
              _this13.edit.website = company.url;
              _this13.edit.vat_no = company.vat_no;
              _this13.edit.phone = company.phone;
              _this13.edit.phone_code = company.phone_code;
              _this13.edit.contact_person = company.contact_person;
              _this13.edit.country_code = company.country_code;
              _this13.errors = {};
    ...
    updateContactPerson: function updateContactPerson(e) {
      this.create.phone_code = e.countryCallingCode;
      this.create.country_code = e.countryCode;
      this.isVaildPhone = e.isValid;
    },
    updateContactPersonEdit: function updateContactPersonEdit(e) {
      this.edit.phone_code = e.countryCallingCode;
      this.edit.country_code = e.countryCode;
      this.isVaildPhone = e.isValid;
    },
    ...
    sortNumber: function sortNumber(value) {
      return (0,_helper_tableSort__WEBPACK_IMPORTED_MODULE_6__.dynamicSortNumber)(value);
    },
      ...
      if (file) {
        ...
        if (!this.idDelete) {
          ...
          _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/media", formDate).then(function (res) {
            var old_media = [];
            if (_this14.images) _this14.images.forEach(function (e) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].put("/companies/".concat(_this14.company_id), {
              old_media: old_media,
              media: new_media
            }).then(function (res) {
...
/* harmony export */   staticRenderFns: () => (/* binding */ staticRenderFns)
/* harmony export */ });
var render=function render(){var _vm=this,_c=_vm._self._c;return _c("Layout",[_c("PageHeader"),_vm._v(" "),_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-12"},[_c("div",{staticClass:"card"},[_c("div",{staticClass:"card-body"},[_c("div",{staticClass:"row justify-content-between align-items-center mb-2"},[_c("h4",{staticClass:"header-title"},[_vm._v(_vm._s(_vm.$t("company.companysTable")))]),_vm._v(" "),_c("div",{staticClass:"col-xs-10 col-md-9 col-lg-7",staticStyle:{"font-weight":"500"}},[_c("div",{staticClass:"d-inline-block",staticStyle:{width:"22.2%"}},[_c("b-dropdown",{ref:"dropdown",staticClass:"btn-block setting-search dropdown-menu-custom-company",attrs:{variant:"primary",text:_vm.$t("general.searchSetting")}},[_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:"name"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.Name"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:"name_e"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.Name_en"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:"email"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v("\n                    "+_vm._s(_vm.$t("login.Emailaddress"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:_vm.$i18n.locale=="ar"?"partner.name":"partner.name_e"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v("\n                    "+_vm._s(_vm.$t("partner.partner"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:"url"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.url"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:"phone"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.mobile_no"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:"tax_id"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v(_vm._s(_vm.$t("general.taxnumber"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:"cr"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v(_vm._s(_vm.$t("general.CommercialRecord"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:"vat_no"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v(_vm._s(_vm.$t("general.Valueaddedregistrationnumber"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:"address"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v(_vm._s(_vm.$t("general.address"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",attrs:{value:"vat_no"},model:{value:_vm.filterSetting,callback:function callback($$v){_vm.filterSetting=$$v;},expression:"filterSetting"}},[_vm._v(_vm._s(_vm.$t("general.website"))+"\n                  ")])],1)],1),_vm._v(" "),_c("div",{staticClass:"d-inline-block position-relative",staticStyle:{width:"77%"}},[_c("span",{"class":["search-custom position-absolute",_vm.$i18n.locale=="ar"?"search-custom-ar":""]},[_c("i",{staticClass:"fe-search"})]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.search,expression:"search",modifiers:{trim:true}}],staticClass:"form-control",staticStyle:{display:"block",width:"93%","padding-top":"3px"},attrs:{type:"text",placeholder:"".concat(_vm.$t("general.Search"),"...")},domProps:{value:_vm.search},on:{input:function input($event){if($event.target.composing)return;_vm.search=$event.target.value.trim();},blur:function blur($event){return _vm.$forceUpdate();}}})])])]),_vm._v(" "),_c("div",{staticClass:"row justify-content-between align-items-center mb-2 px-1"},[_c("div",{staticClass:"col-md-3 d-flex align-items-center mb-1 mb-xl-0"},[_c("b-button",{directives:[{name:"b-modal",rawName:"v-b-modal.create",modifiers:{create:true}}],staticClass:"btn-sm mx-1 font-weight-bold",attrs:{variant:"primary"}},[_vm._v("\n                "+_vm._s(_vm.$t("general.Create"))+"\n                "),_c("i",{staticClass:"fas fa-plus"})]),_vm._v(" "),_c("div",{staticClass:"d-inline-flex"},[_c("button",{staticClass:"custom-btn-dowonload",on:{click:function click($event){return _vm.ExportExcel("xlsx");}}},[_c("i",{staticClass:"fas fa-file-download"})]),_vm._v(" "),_c("button",{directives:[{name:"print",rawName:"v-print",value:"#printMe",expression:"'#printMe'"}],staticClass:"custom-btn-dowonload"},[_c("i",{staticClass:"fe-printer"})]),_vm._v(" "),_vm.checkAll.length==1?_c("button",{staticClass:"custom-btn-dowonload",on:{click:function click($event){return _vm.$bvModal.show("modal-edit-".concat(_vm.checkAll[0]));}}},[_c("i",{staticClass:"mdi mdi-square-edit-outline"})]):_vm._e(),_vm._v(" "),_vm.checkAll.length>1?_c("button",{staticClass:"custom-btn-dowonload",on:{click:function click($event){$event.preventDefault();return _vm.deletecompany(_vm.checkAll);}}},[_c("i",{staticClass:"fas fa-trash-alt"})]):_vm._e(),_vm._v(" "),_vm.checkAll.length==1?_c("button",{staticClass:"custom-btn-dowonload",on:{click:function click($event){$event.preventDefault();return _vm.deletecompany(_vm.checkAll[0]);}}},[_c("i",{staticClass:"fas fa-trash-alt"})]):_vm._e()])],1),_vm._v(" "),_c("div",{staticClass:"col-xs-10 col-md-9 col-lg-7 d-flex align-items-center justify-content-end"},[_c("div",[_c("b-button",{staticClass:"mx-1 custom-btn-background"},[_vm._v("\n                  "+_vm._s(_vm.$t("general.filter"))+"\n                  "),_c("i",{staticClass:"fas fa-filter"})]),_vm._v(" "),_c("b-button",{staticClass:"mx-1 custom-btn-background"},[_vm._v("\n                  "+_vm._s(_vm.$t("general.group"))+"\n                  "),_c("i",{staticClass:"fe-menu"})]),_vm._v(" "),_c("b-dropdown",{ref:"dropdown",staticClass:"dropdown-custom-ali dropdown-menu-custom-company",attrs:{variant:"primary",html:"".concat(_vm.$t("general.setting")," <i class='fe-settings'></i>")}},[_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.name,callback:function callback($$v){_vm.$set(_vm.setting,"name",$$v);},expression:"setting.name"}},[_vm._v(_vm._s(_vm.$t("general.Name"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.name_e,callback:function callback($$v){_vm.$set(_vm.setting,"name_e",$$v);},expression:"setting.name_e"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.Name_en"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.email,callback:function callback($$v){_vm.$set(_vm.setting,"email",$$v);},expression:"setting.email"}},[_vm._v("\n                    "+_vm._s(_vm.$t("login.Emailaddress"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.address,callback:function callback($$v){_vm.$set(_vm.setting,"address",$$v);},expression:"setting.address"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.address"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.phone,callback:function callback($$v){_vm.$set(_vm.setting,"phone",$$v);},expression:"setting.phone"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.mobile_no"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.partner_id,callback:function callback($$v){_vm.$set(_vm.setting,"partner_id",$$v);},expression:"setting.partner_id"}},[_vm._v("\n                    "+_vm._s(_vm.$t("partner.partner"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.cr,callback:function callback($$v){_vm.$set(_vm.setting,"cr",$$v);},expression:"setting.cr"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.CommercialRecord"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.tax_id,callback:function callback($$v){_vm.$set(_vm.setting,"tax_id",$$v);},expression:"setting.tax_id"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.taxnumber"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.is_active,callback:function callback($$v){_vm.$set(_vm.setting,"is_active",$$v);},expression:"setting.is_active"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.Status"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.vat_no,callback:function callback($$v){_vm.$set(_vm.setting,"vat_no",$$v);},expression:"setting.vat_no"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.Valueaddedregistrationnumber"))+"\n                  ")]),_vm._v(" "),_c("b-form-checkbox",{staticClass:"mb-1",model:{value:_vm.setting.website,callback:function callback($$v){_vm.$set(_vm.setting,"website",$$v);},expression:"setting.website"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.website"))+"\n                  ")]),_vm._v(" "),_c("div",{staticClass:"d-flex justify-content-end"},[_c("a",{staticClass:"btn btn-primary btn-sm",attrs:{href:"javascript:void(0)"}},[_vm._v("Apply")])])],1),_vm._v(" "),_c("div",{staticClass:"d-inline-flex align-items-center pagination-custom"},[_c("div",{staticClass:"d-inline-block",staticStyle:{"font-size":"15px"}},[_vm._v("\n                    "+_vm._s(_vm.companiesPagination.from)+"-"+_vm._s(_vm.companiesPagination.to)+"\n                    /\n                    "+_vm._s(_vm.companiesPagination.total)+"\n                  ")]),_vm._v(" "),_c("div",{staticClass:"d-inline-block"},[_c("a",{style:{"pointer-events":_vm.companiesPagination.current_page==1?"none":""},attrs:{href:"javascript:void(0)"},on:{click:function click($event){$event.preventDefault();return _vm.getData(_vm.companiesPagination.current_page-1);}}},[_c("span",[_vm._v("<")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model",value:_vm.current_page,expression:"current_page"}],staticClass:"pagination-current-page",attrs:{type:"text"},domProps:{value:_vm.current_page},on:{keyup:function keyup($event){if(!$event.type.indexOf("key")&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter"))return null;return _vm.getDataCurrentPage();},input:function input($event){if($event.target.composing)return;_vm.current_page=$event.target.value;}}}),_vm._v(" "),_c("a",{style:{"pointer-events":_vm.companiesPagination.last_page==_vm.companiesPagination.current_page?"none":""},attrs:{href:"javascript:void(0)"},on:{click:function click($event){$event.preventDefault();return _vm.getData(_vm.companiesPagination.current_page+1);}}},[_c("span",[_vm._v(">")])])])])],1)])]),_vm._v(" "),_c("b-modal",{attrs:{id:"create",title:_vm.$t("company.addcompany"),"title-class":"font-18","dialog-class":"modal-full-width","body-class":"paddingUnset","hide-footer":true},on:{show:_vm.resetModal,hidden:_vm.resetModalHidden}},[_c("form",{on:{submit:function submit($event){$event.stopPropagation();$event.preventDefault();return _vm.AddSubmit.apply(null,arguments);}}},[_c("div",{staticClass:"card"},[_c("div",{staticClass:"card-body"},[_c("div",{staticClass:"mt-1 d-flex justify-content-end"},[_c("b-button",{"class":["font-weight-bold px-2",_vm.company_id?"mx-2":""],attrs:{variant:"success",disabled:!_vm.company_id,type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.resetForm.apply(null,arguments);}}},[_vm._v("\n                      "+_vm._s(_vm.$t("general.AddNewRecord"))+"\n                    ")]),_vm._v(" "),!_vm.company_id?[!_vm.isLoader?_c("b-button",{staticClass:"mx-1 font-weight-bold px-3",attrs:{variant:"success",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.AddSubmit.apply(null,arguments);}}},[_vm._v("\n                        "+_vm._s(_vm.$t("general.Save"))+"\n                      ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1)]:_vm._e(),_vm._v(" "),_c("b-button",{staticClass:"font-weight-bold",attrs:{variant:"danger",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.resetModalHidden.apply(null,arguments);}}},[_vm._v("\n                      "+_vm._s(_vm.$t("general.Cancel"))+"\n                    ")])],2)]),_vm._v(" "),_c("b-tabs",{attrs:{"nav-class":"nav-tabs nav-bordered"}},[_c("b-tab",{attrs:{title:_vm.$t("general.DataEntry"),active:""}},[_c("div",{staticClass:"row justify-content-between"},[_c("div",{staticClass:"col-7"},[_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group position-relative"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                "+_vm._s(_vm.$t("partner.partner"))+"\n                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("multiselect",{attrs:{options:_vm.partners.map(function(type){return type.id;}),"custom-label":function customLabel(opt){return _vm.$i18n.locale?_vm.partners.find(function(x){return x.id==opt;}).name:_vm.partners.find(function(x){return x.id==opt;}).name_e;}},model:{value:_vm.create.partner_id,callback:function callback($$v){_vm.$set(_vm.create,"partner_id",$$v);},expression:"create.partner_id"}}),_vm._v(" "),!_vm.$v.create.partner_id.integer?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                "+_vm._s(_vm.$t("general.fieldIsInteger"))+"\n                              ")]):_vm._e(),_vm._v(" "),_vm.errors.partner_id?_vm._l(_vm.errors.partner_id,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"}),_vm._v(" "),_c("div",{staticClass:"col-md-6 direction",attrs:{dir:"rtl"}},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-1"}},[_vm._v("\n                                "+_vm._s(_vm.$t("general.Name"))+"\n                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.create.name.$model,expression:"$v.create.name.$model",modifiers:{trim:true}}],staticClass:"form-control arabicInput","class":{"is-invalid":_vm.$v.create.name.$error||_vm.errors.name,"is-valid":!_vm.$v.create.name.$invalid&&!_vm.errors.name},attrs:{type:"text",id:"field-1"},domProps:{value:_vm.$v.create.name.$model},on:{keyup:function keyup($event){return _vm.arabicValue(_vm.create.name);},input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.create.name,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.create.name.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                "+_vm._s(_vm.$v.create.name.$params.minLength.min)+"\n                                "+_vm._s(_vm.$t("general.letters"))+"\n                              ")]):_vm._e(),_vm._v(" "),!_vm.$v.create.name.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                "+_vm._s(_vm.$v.create.name.$params.maxLength.max)+"\n                                "+_vm._s(_vm.$t("general.letters"))+"\n                              ")]):_vm._e(),_vm._v(" "),_vm.errors.name?_vm._l(_vm.errors.name,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6 direction-ltr",attrs:{dir:"ltr"}},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-2"}},[_vm._v("\n                                "+_vm._s(_vm.$t("general.Name_en"))+"\n                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.create.name_e.$model,expression:"$v.create.name_e.$model",modifiers:{trim:true}}],staticClass:"form-control englishInput","class":{"is-invalid":_vm.$v.create.name_e.$error||_vm.errors.name_e,"is-valid":!_vm.$v.create.name_e.$invalid&&!_vm.errors.name_e},attrs:{type:"text",id:"field-2"},domProps:{value:_vm.$v.create.name_e.$model},on:{keyup:function keyup($event){return _vm.englishValue(_vm.create.name_e);},input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.create.name_e,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.create.name_e.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                "+_vm._s(_vm.$v.create.name_e.$params.minLength.min)+"\n                                "+_vm._s(_vm.$t("general.letters"))+"\n                              ")]):_vm._e(),_vm._v(" "),!_vm.$v.create.name_e.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                "+_vm._s(_vm.$v.create.name_e.$params.maxLength.max)+"\n                                "+_vm._s(_vm.$t("general.letters"))+"\n                              ")]):_vm._e(),_vm._v(" "),_vm.errors.name_e?_vm._l(_vm.errors.name_e,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-3"}},[_vm._v("\n                                "+_vm._s(_vm.$t("login.Emailaddress"))+"\n                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.create.email.$model,expression:"$v.create.email.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.create.email.$error||_vm.errors.email,"is-valid":!_vm.$v.create.email.$invalid&&!_vm.errors.email},attrs:{type:"email",id:"field-3"},domProps:{value:_vm.$v.create.email.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.create.email,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.create.email.email?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                "+_vm._s(_vm.$t("general.PleaseEnterValidEmail"))+"\n                              ")]):_vm._e(),_vm._v(" "),!_vm.$v.create.email.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                "+_vm._s(_vm.$v.create.email.$params.minLength.min)+"\n                                "+_vm._s(_vm.$t("general.letters"))+"\n                              ")]):_vm._e(),_vm._v(" "),!_vm.$v.create.email.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                "+_vm._s(_vm.$v.create.email.$params.maxLength.max)+"\n                                "+_vm._s(_vm.$t("general.letters"))+"\n                              ")]):_vm._e(),_vm._v(" "),_vm.errors.email?_vm._l(_vm.errors.email,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-12"}},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.address"))+"\n                                    ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.create.address.$model,expression:"$v.create.address.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.create.address.$error||_vm.errors.address,"is-valid":!_vm.$v.create.address.$invalid&&!_vm.errors.address},attrs:{type:"text",id:"field-12"},domProps:{value:_vm.$v.create.address.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.create.address,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.create.address.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                        "+_vm._s(_vm.$v.create.address.$params.minLength.min)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                    ")]):_vm._e(),_vm._v(" "),!_vm.$v.create.address.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                        "+_vm._s(_vm.$v.create.address.$params.maxLength.max)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                    ")]):_vm._e(),_vm._v(" "),_vm.errors.address?_vm._l(_vm.errors.address,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                "+_vm._s(_vm.$t("general.mobile_no"))+"\n                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("VuePhoneNumberInput",{attrs:{"default-country-code":"KW","valid-color":"#28a745","error-color":"#dc3545","preferred-countries":["FR","EG","DE"]},on:{update:_vm.updatePhone},model:{value:_vm.$v.create.phone.$model,callback:function callback($$v){_vm.$set(_vm.$v.create.phone,"$model",$$v);},expression:"$v.create.phone.$model"}}),_vm._v(" "),_vm.errors.phone?_vm._l(_vm.errors.phone,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.contact_person"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("VuePhoneNumberInput",{attrs:{"default-country-code":"KW","valid-color":"#28a745","error-color":"#dc3545","preferred-countries":["FR","EG","DE"]},on:{update:_vm.updateContactPerson},model:{value:_vm.$v.create.contact_person.$model,callback:function callback($$v){_vm.$set(_vm.$v.create.contact_person,"$model",$$v);},expression:"$v.create.contact_person.$model"}}),_vm._v(" "),_vm.errors.contact_person?_vm._l(_vm.errors.contact_person,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-11"}},[_vm._v("\n                                "+_vm._s(_vm.$t("general.website"))+"\n                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.create.website.$model,expression:"$v.create.website.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.create.website.$error||_vm.errors.website,"is-valid":!_vm.$v.create.website.$invalid&&!_vm.errors.website},attrs:{type:"url",id:"field-11"},domProps:{value:_vm.$v.create.website.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.create.website,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.create.website.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                "+_vm._s(_vm.$v.create.website.$params.minLength.min)+"\n                                "+_vm._s(_vm.$t("general.letters"))+"\n                              ")]):_vm._e(),_vm._v(" "),!_vm.$v.create.website.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                "+_vm._s(_vm.$v.create.website.$params.maxLength.max)+"\n                                "+_vm._s(_vm.$t("general.letters"))+"\n                              ")]):_vm._e(),_vm._v(" "),!_vm.$v.create.website.url?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                "+_vm._s(_vm.$t("general.Itmustbeyourlink"))+"\n                              ")]):_vm._e(),_vm._v(" "),_vm.errors.website?_vm._l(_vm.errors.website,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)])])]),_vm._v(" "),_c("div",{staticClass:"col-4"},[_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-6",staticStyle:{height:"67.6px"}}),_vm._v(" "),_c("div",{staticClass:"col-md-6",staticStyle:{height:"67.6px"}}),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-5"}},[_vm._v("\n                                "+_vm._s(_vm.$t("general.taxnumber"))+"\n                              ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.create.tax_id.$model,expression:"$v.create.tax_id.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.create.tax_id.$error||_vm.errors.tax_id,"is-valid":!_vm.$v.create.tax_id.$invalid&&!_vm.errors.tax_id},attrs:{min:"0",type:"number",id:"field-5"},domProps:{value:_vm.$v.create.tax_id.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.create.tax_id,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.tax_id?_vm._l(_vm.errors.tax_id,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-8"}},[_vm._v("\n                                "+_vm._s(_vm.$t("general.CommercialRecord"))+"\n                              ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.create.cr.$model,expression:"$v.create.cr.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.create.cr.$error||_vm.errors.cr,"is-valid":!_vm.$v.create.cr.$invalid&&!_vm.errors.cr},attrs:{type:"text",id:"field-8"},domProps:{value:_vm.$v.create.cr.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.create.cr,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.cr?_vm._l(_vm.errors.cr,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",staticStyle:{"font-size":"10px"},attrs:{"for":"field-6"}},[_vm._v("\n                                "+_vm._s(_vm.$t("general.Valueaddedregistrationnumber"))+"\n                              ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.create.vat_no.$model,expression:"$v.create.vat_no.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.create.vat_no.$error||_vm.errors.vat_no,"is-valid":!_vm.$v.create.vat_no.$invalid&&!_vm.errors.vat_no},attrs:{type:"number",id:"field-6"},domProps:{value:_vm.$v.create.vat_no.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.create.vat_no,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.vat_no?_vm._l(_vm.errors.vat_no,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"mr-2"},[_vm._v("\n                                "+_vm._s(_vm.$t("general.Status"))+"\n                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("b-form-group",{"class":{"is-invalid":_vm.$v.create.is_active.$error||_vm.errors.is_active,"is-valid":!_vm.$v.create.is_active.$invalid&&!_vm.errors.is_active}},[_c("b-form-radio",{staticClass:"d-inline-block",attrs:{name:"some-radios",value:"active"},model:{value:_vm.$v.create.is_active.$model,callback:function callback($$v){_vm.$set(_vm.$v.create.is_active,"$model",$$v);},expression:"$v.create.is_active.$model"}},[_vm._v(_vm._s(_vm.$t("general.Active")))]),_vm._v(" "),_c("b-form-radio",{staticClass:"d-inline-block m-1",attrs:{name:"some-radios",value:"inactive"},model:{value:_vm.$v.create.is_active.$model,callback:function callback($$v){_vm.$set(_vm.$v.create.is_active,"$model",$$v);},expression:"$v.create.is_active.$model"}},[_vm._v(_vm._s(_vm.$t("general.Inactive")))])],1),_vm._v(" "),_vm.errors.is_active?_vm._l(_vm.errors.is_active,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                ")]);}):_vm._e()],2)])])])])]),_vm._v(" "),_c("b-tab",{attrs:{disabled:!_vm.company_id,title:_vm.$t("company.LogoFileUpload")}},[_c("div",{staticClass:"row"},[_c("input",{staticClass:"input-file-upload position-absolute d-none",attrs:{accept:"image/png, image/gif, image/jpeg, image/jpg",type:"file",id:"uploadImageCreate"},on:{change:function change($event){$event.preventDefault();return _vm.onImageChanged.apply(null,arguments);}}}),_vm._v(" "),_c("div",{staticClass:"col-md-8 my-1"},[_c("div",{staticClass:"row align-content-between",staticStyle:{width:"100%",height:"100%"}},[_c("div",{staticClass:"col-12"},[_c("div",{staticClass:"d-flex flex-wrap"},_vm._l(_vm.images,function(photo,index){return _c("div",{key:photo.id,"class":["dropzone-previews col-4 position-relative mb-2"]},[_c("div",{"class":["card mb-0 shadow-none border",_vm.images.length-1==index?"bg-primary":""]},[_c("div",{staticClass:"p-2"},[_c("div",{staticClass:"row align-items-center"},[_c("div",{staticClass:"col-auto",on:{click:function click($event){_vm.showPhoto=photo.webp;}}},[_c("img",{staticClass:"avatar-sm rounded bg-light",attrs:{"data-dz-thumbnail":"",src:photo.webp},on:{error:function error($event){_vm.src="./images/img-1.png";}}})]),_vm._v(" "),_c("div",{staticClass:"col pl-0"},[_c("a",{"class":["font-weight-bold",_vm.images.length-1==index?"text-white":"text-muted"],attrs:{href:"javascript:void(0);","data-dz-name":""}},[_vm._v("\n                                          "+_vm._s(photo.name)+"\n                                        ")])]),_vm._v(" "),_c("a",{"class":["btn-danger dropzone-close",_vm.$i18n.locale=="ar"?"dropzone-close-rtl":""],attrs:{href:"javascript:void(0);","data-dz-remove":""},on:{click:function click($event){$event.preventDefault();return _vm.deleteImageCreate(photo.id,index);}}},[_c("i",{staticClass:"fe-x"})])])])])]);}),0)]),_vm._v(" "),_c("div",{staticClass:"footer-image col-12"},[!_vm.isLoader?_c("b-button",{staticClass:"mx-1 font-weight-bold px-3",attrs:{variant:"success",type:"button"},on:{click:_vm.changePhoto}},[_vm._v("\n                              "+_vm._s(_vm.$t("general.Add"))+"\n                            ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1)],1)])]),_vm._v(" "),_c("div",{staticClass:"col-md-4"},[_c("div",{staticClass:"show-dropzone"},[_c("img",{staticClass:"img-thumbnail",attrs:{src:_vm.showPhoto},on:{error:function error($event){_vm.src="./images/img-1.png";}}})])])])])],1)],1)])]),_vm._v(" "),_c("div",{staticClass:"table-responsive mb-3 custom-table-theme position-relative"},[_vm.isLoader?_c("loader",{attrs:{size:"large"}}):_vm._e(),_vm._v(" "),_c("table",{ref:"exportable_table",staticClass:"table table-borderless table-hover table-centered m-0",attrs:{id:"printMe"}},[_c("thead",[_c("tr",[_vm.enabled3?_c("th",{staticClass:"do-not-print",staticStyle:{width:"0"},attrs:{scope:"col"}},[_c("div",{staticClass:"form-check custom-control"},[_c("input",{directives:[{name:"model",rawName:"v-model",value:_vm.isCheckAll,expression:"isCheckAll"}],staticClass:"form-check-input",staticStyle:{width:"17px",height:"17px"},attrs:{type:"checkbox"},domProps:{checked:Array.isArray(_vm.isCheckAll)?_vm._i(_vm.isCheckAll,null)>-1:_vm.isCheckAll},on:{change:function change($event){var $$a=_vm.isCheckAll,$$el=$event.target,$$c=$$el.checked?true:false;if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.isCheckAll=$$a.concat([$$v]));}else{$$i>-1&&(_vm.isCheckAll=$$a.slice(0,$$i).concat($$a.slice($$i+1)));}}else{_vm.isCheckAll=$$c;}}}})])]):_vm._e(),_vm._v(" "),_vm.setting.name?_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.Name")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortString("name"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortString("-name"));}}})])])]):_vm._e(),_vm._v(" "),_vm.setting.name_e?_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.Name_en")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortString("name_e"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortString("-name_e"));}}})])])]):_vm._e(),_vm._v(" "),_vm.setting.email?_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("login.Emailaddress")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortString("email"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortString("-email"));}}})])])]):_vm._e(),_vm._v(" "),_vm.setting.partner_id?_c("th",[_vm._v("\n                    "+_vm._s(_vm.$t("partner.partner"))+"\n                  ")]):_vm._e(),_vm._v(" "),_vm.setting.phone?_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.mobile_no")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("phone"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("-phone"));}}})])])]):_vm._e(),_vm._v(" "),_vm.setting.vat_no?_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.Valueaddedregistrationnumber")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("vat_no"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("-vat_no"));}}})])])]):_vm._e(),_vm._v(" "),_vm.setting.cr?_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.CommercialRecord")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("cr"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("-cr"));}}})])])]):_vm._e(),_vm._v(" "),_vm.setting.tax_id?_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.taxnumber")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("tax_id"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortNumber("-tax_id"));}}})])])]):_vm._e(),_vm._v(" "),_vm.setting.address?_c("th",[_c("div",{staticClass:"d-flex justify-content-center"},[_c("span",[_vm._v(" "+_vm._s(_vm.$t("general.address")))]),_vm._v(" "),_c("div",{staticClass:"arrow-sort"},[_c("i",{staticClass:"fas fa-arrow-up",on:{click:function click($event){_vm.companies.sort(_vm.sortString("address"));}}}),_vm._v(" "),_c("i",{staticClass:"fas fa-arrow-down",on:{click:function click($event){_vm.companies.sort(_vm.sortString("-address"));}}})])])]):_vm._e(),_vm._v(" "),_vm.setting.website?_c("th",[_vm._v(_vm._s(_vm.$t("general.website")))]):_vm._e(),_vm._v(" "),_vm.setting.is_active?_c("th",[_vm._v(_vm._s(_vm.$t("general.Status")))]):_vm._e(),_vm._v(" "),_vm.enabled3?_c("th",{staticClass:"do-not-print"},[_vm._v("\n                    "+_vm._s(_vm.$t("general.Action"))+"\n                  ")]):_vm._e(),_vm._v(" "),_vm.enabled3?_c("th",{staticClass:"do-not-print"},[_c("i",{staticClass:"fas fa-ellipsis-v"})]):_vm._e()])]),_vm._v(" "),_vm.companies.length>0?_c("tbody",_vm._l(_vm.companies,function(data,index){return _c("tr",{key:data.id,staticClass:"body-tr-custom",on:{"!click":function click($event){return _vm.checkRow(data.id);},dblclick:function dblclick($event){$event.preventDefault();return _vm.$bvModal.show("modal-edit-".concat(data.id));}}},[_vm.enabled3?_c("td",{staticClass:"do-not-print"},[_c("div",{staticClass:"form-check custom-control",staticStyle:{"min-height":"1.9em"}},[_c("input",{directives:[{name:"model",rawName:"v-model",value:_vm.checkAll,expression:"checkAll"}],staticClass:"form-check-input",staticStyle:{width:"17px",height:"17px"},attrs:{type:"checkbox"},domProps:{value:data.id,checked:Array.isArray(_vm.checkAll)?_vm._i(_vm.checkAll,data.id)>-1:_vm.checkAll},on:{change:function change($event){var $$a=_vm.checkAll,$$el=$event.target,$$c=$$el.checked?true:false;if(Array.isArray($$a)){var $$v=data.id,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.checkAll=$$a.concat([$$v]));}else{$$i>-1&&(_vm.checkAll=$$a.slice(0,$$i).concat($$a.slice($$i+1)));}}else{_vm.checkAll=$$c;}}}})])]):_vm._e(),_vm._v(" "),_vm.setting.name?_c("td",[_vm._v("\n                    "+_vm._s(data.name)+"\n                  ")]):_vm._e(),_vm._v(" "),_vm.setting.name_e?_c("td",[_vm._v("\n                    "+_vm._s(data.name_e)+"\n                  ")]):_vm._e(),_vm._v(" "),_vm.setting.email?_c("td",[_vm._v("\n                    "+_vm._s(data.email)+"\n                  ")]):_vm._e(),_vm._v(" "),_vm.setting.partner_id?_c("td",[_vm._v("\n                    "+_vm._s(_vm.$i18n.locale=="ar"?data.partner.name:data.partner.name_e)+"\n                  ")]):_vm._e(),_vm._v(" "),_vm.setting.phone?_c("td",[_vm._v("\n                    "+_vm._s(data.phone)+"\n                  ")]):_vm._e(),_vm._v(" "),_vm.setting.vat_no?_c("td",[_vm._v("\n                    "+_vm._s(data.vat_no)+"\n                  ")]):_vm._e(),_vm._v(" "),_vm.setting.cr?_c("td",[_vm._v("\n                    "+_vm._s(data.cr)+"\n                  ")]):_vm._e(),_vm._v(" "),_vm.setting.tax_id?_c("td",[_vm._v("\n                    "+_vm._s(data.tax_id)+"\n                  ")]):_vm._e(),_vm._v(" "),_vm.setting.address?_c("td",[_vm._v("\n                    "+_vm._s(data.address)+"\n                  ")]):_vm._e(),_vm._v(" "),_vm.setting.website?_c("td",[_vm._v("\n                    "+_vm._s(data.url)+"\n                  ")]):_vm._e(),_vm._v(" "),_vm.setting.is_active?_c("td",[_c("span",{"class":[data.is_active=="active"?"bg-soft-success text-success":"bg-soft-danger  text-danger","badge"]},[_vm._v("\n                      "+_vm._s(data.is_active=="active"?"".concat(_vm.$t("general.Active")):"".concat(_vm.$t("general.Inactive")))+"\n                    ")])]):_vm._e(),_vm._v(" "),_vm.enabled3?_c("td",{staticClass:"do-not-print"},[_c("div",{staticClass:"btn-group"},[_c("button",{staticClass:"btn btn-sm dropdown-toggle dropdown-coustom",attrs:{type:"button","data-toggle":"dropdown","aria-expanded":"false"}},[_vm._v("\n                        "+_vm._s(_vm.$t("general.commands"))+"\n                        "),_c("i",{staticClass:"fas fa-angle-down"})]),_vm._v(" "),_c("div",{staticClass:"dropdown-menu dropdown-menu-custom"},[_c("a",{staticClass:"dropdown-item",attrs:{href:"#"},on:{click:function click($event){return _vm.$bvModal.show("modal-edit-".concat(data.id));}}},[_c("div",{staticClass:"d-flex justify-content-between align-items-center text-black"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.edit")))]),_vm._v(" "),_c("i",{staticClass:"mdi mdi-square-edit-outline text-info"})])]),_vm._v(" "),_c("a",{staticClass:"dropdown-item text-black",attrs:{href:"#"},on:{click:function click($event){$event.preventDefault();return _vm.deletecompany(data.id);}}},[_c("div",{staticClass:"d-flex justify-content-between align-items-center text-black"},[_c("span",[_vm._v(_vm._s(_vm.$t("general.delete")))]),_vm._v(" "),_c("i",{staticClass:"fas fa-times text-danger"})])])])]),_vm._v(" "),_c("b-modal",{ref:"edit-".concat(data.id),refInFor:true,attrs:{id:"modal-edit-".concat(data.id),title:_vm.$t("company.editcompany"),"title-class":"font-18","dialog-class":"modal-full-width","body-class":"paddingUnset","hide-footer":true},on:{show:function show($event){return _vm.resetModalEdit(data.id);},hidden:function hidden($event){return _vm.resetModalHiddenEdit(data.id);}}},[_c("form",[_c("div",{staticClass:"card-body"},[_c("div",{staticClass:"mt-1 d-flex justify-content-end"},[!_vm.isLoader?_c("b-button",{staticClass:"mx-1 font-weight-bold px-3",attrs:{variant:"success",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.editSubmit(data.id,index);}}},[_vm._v("\n                              "+_vm._s(_vm.$t("general.Save"))+"\n                            ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1),_vm._v(" "),_c("b-button",{staticClass:"font-weight-bold",attrs:{variant:"danger",type:"button"},on:{click:function click($event){$event.preventDefault();return _vm.$bvModal.hide("modal-edit-".concat(data.id));}}},[_vm._v("\n                              "+_vm._s(_vm.$t("general.Cancel"))+"\n                            ")])],1)]),_vm._v(" "),_c("b-tabs",{attrs:{"nav-class":"nav-tabs nav-bordered"}},[_c("b-tab",{attrs:{title:_vm.$t("general.DataEntry"),active:""}},[_c("div",{staticClass:"row justify-content-between"},[_c("div",{staticClass:"col-7"},[_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group position-relative"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                        "+_vm._s(_vm.$t("partner.partner"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("multiselect",{attrs:{options:_vm.partners.map(function(type){return type.id;}),"custom-label":function customLabel(opt){return _vm.$i18n.locale?_vm.partners.find(function(x){return x.id==opt;}).name:_vm.partners.find(function(x){return x.id==opt;}).name_e;}},model:{value:_vm.edit.partner_id,callback:function callback($$v){_vm.$set(_vm.edit,"partner_id",$$v);},expression:"edit.partner_id"}}),_vm._v(" "),!_vm.$v.edit.partner_id.integer?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.fieldIsInteger"))+"\n                                      ")]):_vm._e(),_vm._v(" "),_vm.errors.partner_id?_vm._l(_vm.errors.partner_id,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"}),_vm._v(" "),_c("div",{staticClass:"col-md-6 direction",attrs:{dir:"rtl"}},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"edit-1"}},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Name"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.edit.name.$model,expression:"$v.edit.name.$model",modifiers:{trim:true}}],staticClass:"form-control arabicInput","class":{"is-invalid":_vm.$v.edit.name.$error||_vm.errors.name,"is-valid":!_vm.$v.edit.name.$invalid&&!_vm.errors.name},attrs:{type:"text",id:"edit-1"},domProps:{value:_vm.$v.edit.name.$model},on:{keyup:function keyup($event){return _vm.arabicValue(_vm.edit.name);},input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.edit.name,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.edit.name.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                        "+_vm._s(_vm.$v.edit.name.$params.minLength.min)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.name.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                        "+_vm._s(_vm.$v.edit.name.$params.maxLength.max)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.name.alphaArabic?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.alphaArabic"))+"\n                                      ")]):_vm._e(),_vm._v(" "),_vm.errors.name?_vm._l(_vm.errors.name,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6 direction-ltr",attrs:{dir:"ltr"}},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-2"}},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Name_en"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.edit.name_e.$model,expression:"$v.edit.name_e.$model",modifiers:{trim:true}}],staticClass:"form-control englishInput","class":{"is-invalid":_vm.$v.edit.name_e.$error||_vm.errors.name_e,"is-valid":!_vm.$v.edit.name_e.$invalid&&!_vm.errors.name_e},attrs:{type:"text",id:"edit-2"},domProps:{value:_vm.$v.edit.name_e.$model},on:{keyup:function keyup($event){return _vm.englishValue(_vm.edit.name_e);},input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.edit.name_e,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.edit.name_e.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                        "+_vm._s(_vm.$v.edit.name_e.$params.minLength.min)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.name_e.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                        "+_vm._s(_vm.$v.edit.name_e.$params.maxLength.max)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.name_e.alphaEnglish?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.alphaEnglish"))+"\n                                      ")]):_vm._e(),_vm._v(" "),_vm.errors.name_e?_vm._l(_vm.errors.name_e,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"edit-3"}},[_vm._v("\n                                        "+_vm._s(_vm.$t("login.Emailaddress"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.edit.email.$model,expression:"$v.edit.email.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.edit.email.$error||_vm.errors.email,"is-valid":!_vm.$v.edit.email.$invalid&&!_vm.errors.email},attrs:{type:"email",id:"edit-3"},domProps:{value:_vm.$v.edit.email.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.edit.email,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.edit.email.email?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.PleaseEnterValidEmail"))+"\n                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.email.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                        "+_vm._s(_vm.$v.edit.email.$params.minLength.min)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.email.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                        "+_vm._s(_vm.$v.edit.email.$params.maxLength.max)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                      ")]):_vm._e(),_vm._v(" "),_vm.errors.email?_vm._l(_vm.errors.email,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-12"}},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.address"))+"\n                                            ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.edit.address.$model,expression:"\n                                          $v.edit.address.$model\n                                        ",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.edit.address.$error||_vm.errors.address,"is-valid":!_vm.$v.edit.address.$invalid&&!_vm.errors.address},attrs:{type:"text",id:"edit-12"},domProps:{value:_vm.$v.edit.address.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.edit.address,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.edit.address.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                                "+_vm._s(_vm.$v.edit.address.$params.minLength.min)+"\n                                                "+_vm._s(_vm.$t("general.letters"))+"\n                                            ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.address.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                                "+_vm._s(_vm.$v.edit.address.$params.maxLength.max)+"\n                                                "+_vm._s(_vm.$t("general.letters"))+"\n                                            ")]):_vm._e(),_vm._v(" "),_vm.errors.address?_vm._l(_vm.errors.address,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.mobile_no"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("VuePhoneNumberInput",{attrs:{"default-country-code":_vm.edit.country_code,"valid-color":"#28a745","error-color":"#dc3545","preferred-countries":["FR","EG","DE"]},on:{update:_vm.updatePhoneEdit},model:{value:_vm.$v.edit.phone.$model,callback:function callback($$v){_vm.$set(_vm.$v.edit.phone,"$model",$$v);},expression:"$v.edit.phone.$model"}}),_vm._v(" "),_vm.errors.phone?_vm._l(_vm.errors.phone,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label"},[_vm._v("\n                                                "+_vm._s(_vm.$t("general.contact_person"))+"\n                                                "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("VuePhoneNumberInput",{attrs:{"default-country-code":"KW","valid-color":"#28a745","error-color":"#dc3545","preferred-countries":["FR","EG","DE"]},on:{update:_vm.updateContactPersonEdit},model:{value:_vm.$v.edit.contact_person.$model,callback:function callback($$v){_vm.$set(_vm.$v.edit.contact_person,"$model",$$v);},expression:"$v.edit.contact_person.$model"}}),_vm._v(" "),_vm.errors.contact_person?_vm._l(_vm.errors.contact_person,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"edit-11"}},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.website"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.edit.website.$model,expression:"\n                                          $v.edit.website.$model\n                                        ",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.edit.website.$error||_vm.errors.website,"is-valid":!_vm.$v.edit.website.$invalid&&!_vm.errors.website},attrs:{type:"url",id:"edit-11"},domProps:{value:_vm.$v.edit.website.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.edit.website,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),!_vm.$v.edit.website.minLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatleast"))+"\n                                        "+_vm._s(_vm.$v.edit.website.$params.minLength.min)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.website.maxLength?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeatmost"))+"\n                                        "+_vm._s(_vm.$v.edit.website.$params.maxLength.max)+"\n                                        "+_vm._s(_vm.$t("general.letters"))+"\n                                      ")]):_vm._e(),_vm._v(" "),!_vm.$v.edit.website.url?_c("div",{staticClass:"invalid-feedback"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Itmustbeyourlink"))+"\n                                      ")]):_vm._e(),_vm._v(" "),_vm.errors.website?_vm._l(_vm.errors.website,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)])])]),_vm._v(" "),_c("div",{staticClass:"col-4"},[_c("div",{staticClass:"row"},[_c("div",{staticClass:"col-md-6",staticStyle:{height:"67.6px"}}),_vm._v(" "),_c("div",{staticClass:"col-md-6",staticStyle:{height:"67.6px"}}),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"edit-5"}},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.taxnumber"))+"\n                                      ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.edit.tax_id.$model,expression:"$v.edit.tax_id.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.edit.tax_id.$error||_vm.errors.tax_id,"is-valid":!_vm.$v.edit.tax_id.$invalid&&!_vm.errors.tax_id},attrs:{type:"number",id:"edit-5"},domProps:{value:_vm.$v.edit.tax_id.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.edit.tax_id,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.tax_id?_vm._l(_vm.errors.tax_id,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",attrs:{"for":"field-8"}},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.CommercialRecord"))+"\n                                      ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.trim",value:_vm.$v.edit.cr.$model,expression:"$v.edit.cr.$model",modifiers:{trim:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.edit.cr.$error||_vm.errors.cr,"is-valid":!_vm.$v.edit.cr.$invalid&&!_vm.errors.cr},attrs:{type:"text",id:"edit-8"},domProps:{value:_vm.$v.edit.cr.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.edit.cr,"$model",$event.target.value.trim());},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.cr?_vm._l(_vm.errors.cr,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-6"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"control-label",staticStyle:{"font-size":"10px"},attrs:{"for":"field-6"}},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Valueaddedregistrationnumber"))+"\n                                      ")]),_vm._v(" "),_c("input",{directives:[{name:"model",rawName:"v-model.number",value:_vm.$v.edit.vat_no.$model,expression:"$v.edit.vat_no.$model",modifiers:{number:true}}],staticClass:"form-control","class":{"is-invalid":_vm.$v.edit.vat_no.$error||_vm.errors.vat_no,"is-valid":!_vm.$v.edit.vat_no.$invalid&&!_vm.errors.vat_no},attrs:{type:"number",id:"edit-6"},domProps:{value:_vm.$v.edit.vat_no.$model},on:{input:function input($event){if($event.target.composing)return;_vm.$set(_vm.$v.edit.vat_no,"$model",_vm._n($event.target.value));},blur:function blur($event){return _vm.$forceUpdate();}}}),_vm._v(" "),_vm.errors.vat_no?_vm._l(_vm.errors.vat_no,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage))]);}):_vm._e()],2)]),_vm._v(" "),_c("div",{staticClass:"col-md-12"},[_c("div",{staticClass:"form-group"},[_c("label",{staticClass:"mr-2"},[_vm._v("\n                                        "+_vm._s(_vm.$t("general.Status"))+"\n                                        "),_c("span",{staticClass:"text-danger"},[_vm._v("*")])]),_vm._v(" "),_c("b-form-group",{"class":{"is-invalid":_vm.$v.edit.is_active.$error||_vm.errors.is_active,"is-valid":!_vm.$v.edit.is_active.$invalid&&!_vm.errors.is_active}},[_c("b-form-radio",{staticClass:"d-inline-block",attrs:{name:"some-radios",value:"active"},model:{value:_vm.$v.edit.is_active.$model,callback:function callback($$v){_vm.$set(_vm.$v.edit.is_active,"$model",$$v);},expression:"$v.edit.is_active.$model"}},[_vm._v(_vm._s(_vm.$t("general.Active")))]),_vm._v(" "),_c("b-form-radio",{staticClass:"d-inline-block m-1",attrs:{name:"some-radios",value:"inactive"},model:{value:_vm.$v.edit.is_active.$model,callback:function callback($$v){_vm.$set(_vm.$v.edit.is_active,"$model",$$v);},expression:"$v.edit.is_active.$model"}},[_vm._v(_vm._s(_vm.$t("general.Inactive")))])],1),_vm._v(" "),_vm.errors.is_active?_vm._l(_vm.errors.is_active,function(errorMessage,index){return _c("ErrorMessage",{key:index},[_vm._v(_vm._s(errorMessage)+"\n                                        ")]);}):_vm._e()],2)])])])])]),_vm._v(" "),_c("b-tab",{attrs:{title:_vm.$t("company.LogoFileUpload")}},[_c("div",{staticClass:"row"},[_c("input",{staticClass:"input-file-upload position-absolute d-none",attrs:{accept:"image/png, image/gif, image/jpeg, image/jpg",type:"file",id:"uploadImageEdit"},on:{change:function change($event){$event.preventDefault();return _vm.onImageChanged.apply(null,arguments);}}}),_vm._v(" "),_c("div",{staticClass:"col-md-8 my-1"},[_c("div",{staticClass:"row align-content-between",staticStyle:{width:"100%",height:"100%"}},[_c("div",{staticClass:"col-12"},[_c("div",{staticClass:"d-flex flex-wrap"},_vm._l(_vm.images,function(photo,index){return _c("div",{key:photo.id,"class":["dropzone-previews col-4 position-relative mb-2"]},[_c("div",{"class":["card mb-0 shadow-none border",_vm.images.length-1==index?"bg-primary":""]},[_c("div",{staticClass:"p-2"},[_c("div",{staticClass:"row align-items-center"},[_c("div",{staticClass:"col-auto",on:{click:function click($event){_vm.showPhoto=photo.webp;}}},[_c("img",{staticClass:"avatar-sm rounded bg-light",attrs:{"data-dz-thumbnail":"",src:photo.webp},on:{error:function error($event){_vm.src="./images/img-1.png";}}})]),_vm._v(" "),_c("div",{staticClass:"col pl-0"},[_c("a",{"class":["font-weight-bold",_vm.images.length-1==index?"text-white":"text-muted"],attrs:{href:"javascript:void(0);","data-dz-name":""}},[_vm._v("\n                                                  "+_vm._s(photo.name)+"\n                                                ")])]),_vm._v(" "),_c("a",{"class":["btn-danger dropzone-close",_vm.$i18n.locale=="ar"?"dropzone-close-rtl":""],attrs:{href:"javascript:void(0);","data-dz-remove":""},on:{click:function click($event){$event.preventDefault();return _vm.deleteImageCreate(photo.id,index);}}},[_c("i",{staticClass:"fe-x"})])])])])]);}),0)]),_vm._v(" "),_c("div",{staticClass:"footer-image col-12"},[!_vm.isLoader?_c("b-button",{staticClass:"mx-1 font-weight-bold px-3",attrs:{variant:"success",type:"button"},on:{click:_vm.changePhotoEdit}},[_vm._v("\n                                      "+_vm._s(_vm.$t("general.Add"))+"\n                                    ")]):_c("b-button",{staticClass:"mx-1",attrs:{variant:"success",disabled:""}},[_c("b-spinner",{attrs:{small:""}}),_vm._v(" "),_c("span",{staticClass:"sr-only"},[_vm._v(_vm._s(_vm.$t("login.Loading"))+"...")])],1)],1)])]),_vm._v(" "),_c("div",{staticClass:"col-md-4"},[_c("div",{staticClass:"show-dropzone"},[_c("img",{staticClass:"img-thumbnail",attrs:{src:_vm.showPhoto},on:{error:function error($event){_vm.src="./images/img-1.png";}}})])])])])],1)],1)])],1):_vm._e(),_vm._v(" "),_vm.enabled3?_c("td",{staticClass:"do-not-print"},[_c("b-button",{staticClass:"btn",attrs:{id:"tooltip-button-"+data.id,variant:_vm.$i18n.locale=="en"?"left":"right"},on:{mouseover:function mouseover($event){return _vm.log(data.id);},mousemove:function mousemove($event){return _vm.log(data.id);}}},[_c("i",{staticClass:"fe-info",staticStyle:{"font-size":"22px"}})]),_vm._v(" "),_c("b-tooltip",{attrs:{target:"tooltip-button-"+data.id,placement:_vm.$i18n.locale=="en"?"left":"right"}},[_vm._v(_vm._s(_vm.Tooltip))])],1):_vm._e()]);}),0):_c("tbody",[_c("tr",[_c("th",{staticClass:"text-center",attrs:{colspan:"15"}},[_vm._v("\n                    "+_vm._s(_vm.$t("general.notDataFound"))+"\n                  ")])])])])],1)],1)])])])],1);};var staticRenderFns=[];render._withStripped=true;
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_03416206_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=03416206&lang=css */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/company/index.vue?vue&type=style&index=0&id=03416206&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_03416206_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _index_vue_vue_type_template_id_03416206__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=03416206 */ "./resources/js/views/pages/company/index.vue?vue&type=template&id=03416206");
/* harmony import */ var _index_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js */ "./resources/js/views/pages/company/index.vue?vue&type=script&lang=js");
/* harmony import */ var _index_vue_vue_type_style_index_0_id_03416206_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=03416206&lang=css */ "./resources/js/views/pages/company/index.vue?vue&type=style&index=0&id=03416206&lang=css");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _index_vue_vue_type_template_id_03416206__WEBPACK_IMPORTED_MODULE_0__.render,
  _index_vue_vue_type_template_id_03416206__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_03416206__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_03416206__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_template_id_03416206__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=template&id=03416206 */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/company/index.vue?vue&type=template&id=03416206");
...
/***/ "./resources/js/views/pages/company/index.vue?vue&type=style&index=0&id=03416206&lang=css":
/*!************************************************************************************************!*\
  !*** ./resources/js/views/pages/company/index.vue?vue&type=style&index=0&id=03416206&lang=css ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_03416206_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./index.vue?vue&type=style&index=0&id=03416206&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/company/index.vue?vue&type=style&index=0&id=03416206&lang=css");
